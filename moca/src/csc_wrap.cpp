...
#define SWIGTYPE_p_StringView swig_types[0]
#define SWIGTYPE_p_allocator_type swig_types[1]
#define SWIGTYPE_p_char swig_types[2]
#define SWIGTYPE_p_chrom_info swig_types[3]
#define SWIGTYPE_p_const_reference swig_types[4]
#define SWIGTYPE_p_difference_type swig_types[5]
#define SWIGTYPE_p_genome_hash_table swig_types[6]
#define SWIGTYPE_p_genome_table swig_types[7]
...
#define SWIGTYPE_p_std__allocatorT_StringView_t swig_types[11]
#define SWIGTYPE_p_std__allocatorT_char_const_p_t swig_types[12]
#define SWIGTYPE_p_std__allocatorT_chrom_info_t swig_types[13]
...
#define SWIGTYPE_p_std__ifstream swig_types[18]
#define SWIGTYPE_p_std__invalid_argument swig_types[19]
#define SWIGTYPE_p_std__ios__pos_type swig_types[20]
#define SWIGTYPE_p_std__string swig_types[21]
#define SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t swig_types[22]
#define SWIGTYPE_p_std__vectorT__Tp__Alloc_t swig_types[23]
#define SWIGTYPE_p_std__vectorT__Tp_const_p__Alloc_t swig_types[24]
#define SWIGTYPE_p_std__vectorT_char_const_p_std__allocatorT_char_const_p_t_t swig_types[25]
#define SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t swig_types[26]
...
#define SWIGTYPE_p_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t swig_types[30]
#define SWIGTYPE_p_swig__SwigPyIterator swig_types[31]
#define SWIGTYPE_p_value_type swig_types[32]
#define SWIGTYPE_p_vectorT_StringView_std__allocatorT_StringView_t_t swig_types[33]
#define SWIGTYPE_p_vectorT_std__string_std__allocatorT_std__string_t_t swig_types[34]
#define SWIGTYPE_p_vectorT_std__vectorT_float_std__allocatorT_float_t_t_std__allocatorT_std__vectorT_float_std__allocatorT_float_t_t_t_t swig_types[35]
...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__csc

#else
#  define SWIG_init    init_csc
...
SWIGINTERN void std_vector_Sl_char_SS_const_Sm__Sg__append(std::vector< char const * > *self,std::vector< char const * >::value_type x){
  ...
  namespace swig {
    template <>  struct traits<StringView > {
      typedef pointer_category category;
      static const char* type_name() { return"StringView"; }
    };
  }


      namespace swig {
	template <>  struct traits<std::vector<StringView, std::allocator< StringView > > > {
	  typedef pointer_category category;
	  static const char* type_name() {
	    return "std::vector<" "StringView" "," "std::allocator< StringView >" " >";
	  }
	};
      }
    
SWIGINTERN swig::SwigPyIterator *std_vector_Sl_StringView_Sg__iterator(std::vector< StringView > *self,PyObject **PYTHON_SELF){
      return swig::make_output_iterator(self->begin(), self->begin(), self->end(), *PYTHON_SELF);
    }
SWIGINTERN bool std_vector_Sl_StringView_Sg____nonzero__(std::vector< StringView > const *self){
      return !(self->empty());
    }
SWIGINTERN bool std_vector_Sl_StringView_Sg____bool__(std::vector< StringView > const *self){
      return !(self->empty());
    }
SWIGINTERN std::vector< StringView >::size_type std_vector_Sl_StringView_Sg____len__(std::vector< StringView > const *self){
      return self->size();
    }
SWIGINTERN std::vector< StringView >::value_type std_vector_Sl_StringView_Sg__pop(std::vector< StringView > *self){
      if (self->size() == 0)
	throw std::out_of_range("pop from empty container");
      std::vector<StringView,std::allocator< StringView > >::value_type x = self->back();
      self->pop_back();
      return x;
    }
SWIGINTERN std::vector< StringView,std::allocator< StringView > > *std_vector_Sl_StringView_Sg____getslice__(std::vector< StringView > *self,std::vector< StringView >::difference_type i,std::vector< StringView >::difference_type j){
      return swig::getslice(self, i, j, 1);
    }
SWIGINTERN void std_vector_Sl_StringView_Sg____setslice____SWIG_0(std::vector< StringView > *self,std::vector< StringView >::difference_type i,std::vector< StringView >::difference_type j,std::vector< StringView,std::allocator< StringView > > const &v=std::vector< StringView,std::allocator< StringView > >()){
      swig::setslice(self, i, j, 1, v);
    }
SWIGINTERN void std_vector_Sl_StringView_Sg____delslice__(std::vector< StringView > *self,std::vector< StringView >::difference_type i,std::vector< StringView >::difference_type j){
      swig::delslice(self, i, j, 1);
    }
SWIGINTERN void std_vector_Sl_StringView_Sg____delitem____SWIG_0(std::vector< StringView > *self,std::vector< StringView >::difference_type i){
      self->erase(swig::getpos(self,i));
    }
SWIGINTERN std::vector< StringView,std::allocator< StringView > > *std_vector_Sl_StringView_Sg____getitem____SWIG_0(std::vector< StringView > *self,PySliceObject *slice){
      Py_ssize_t i, j, step;
      if( !PySlice_Check(slice) ) {
        SWIG_Error(SWIG_TypeError, "Slice object expected.");
        return NULL;
      ...
      PySlice_GetIndices(SWIGPY_SLICE_ARG(slice), (Py_ssize_t)self->size(), &i, &j, &step);
      std::vector<StringView,std::allocator< StringView > >::difference_type id = i;
      std::vector<StringView,std::allocator< StringView > >::difference_type jd = j;
      return swig::getslice(self, id, jd, step);
    }
SWIGINTERN void std_vector_Sl_StringView_Sg____setitem____SWIG_0(std::vector< StringView > *self,PySliceObject *slice,std::vector< StringView,std::allocator< StringView > > const &v){
      Py_ssize_t i, j, step;
      if( !PySlice_Check(slice) ) {
        SWIG_Error(SWIG_TypeError, "Slice object expected.");
        return;
...
SWIGINTERN void std_vector_Sl_StringView_Sg____setitem____SWIG_1(std::vector< StringView > *self,PySliceObject *slice){
      Py_ssize_t i, j, step;
      if( !PySlice_Check(slice) ) {
        SWIG_Error(SWIG_TypeError, "Slice object expected.");
        return;
...
SWIGINTERN void std_vector_Sl_StringView_Sg____delitem____SWIG_1(std::vector< StringView > *self,PySliceObject *slice){
      Py_ssize_t i, j, step;
      if( !PySlice_Check(slice) ) {
        SWIG_Error(SWIG_TypeError, "Slice object expected.");
        return;
...
SWIGINTERN std::vector< StringView >::value_type const &std_vector_Sl_StringView_Sg____getitem____SWIG_1(std::vector< StringView > const *self,std::vector< StringView >::difference_type i){
      return *(swig::cgetpos(self, i));
    }
SWIGINTERN void std_vector_Sl_StringView_Sg____setitem____SWIG_2(std::vector< StringView > *self,std::vector< StringView >::difference_type i,std::vector< StringView >::value_type const &x){
      *(swig::getpos(self,i)) = x;
    }
SWIGINTERN void std_vector_Sl_StringView_Sg__append(std::vector< StringView > *self,std::vector< StringView >::value_type const &x){
      self->push_back(x);
    }

  namespace swig {
    template <>  struct traits<chrom_info > {
      typedef pointer_category category;
      static const char* type_name() { return"chrom_info"; }
    };
  }


      namespace swig {
	template <>  struct traits<std::vector<chrom_info, std::allocator< chrom_info > > > {
	  typedef pointer_category category;
	  static const char* type_name() {
	    return "std::vector<" "chrom_info" "," "std::allocator< chrom_info >" " >";
	  }
	};
      }
    
SWIGINTERN swig::SwigPyIterator *std_vector_Sl_chrom_info_Sg__iterator(std::vector< chrom_info > *self,PyObject **PYTHON_SELF){
      return swig::make_output_iterator(self->begin(), self->begin(), self->end(), *PYTHON_SELF);
    }
SWIGINTERN bool std_vector_Sl_chrom_info_Sg____nonzero__(std::vector< chrom_info > const *self){
      return !(self->empty());
    }
SWIGINTERN bool std_vector_Sl_chrom_info_Sg____bool__(std::vector< chrom_info > const *self){
      return !(self->empty());
    }
SWIGINTERN std::vector< chrom_info >::size_type std_vector_Sl_chrom_info_Sg____len__(std::vector< chrom_info > const *self){
      return self->size();
    }
SWIGINTERN std::vector< chrom_info >::value_type std_vector_Sl_chrom_info_Sg__pop(std::vector< chrom_info > *self){
      if (self->size() == 0)
	throw std::out_of_range("pop from empty container");
      std::vector<chrom_info,std::allocator< chrom_info > >::value_type x = self->back();
      self->pop_back();
      return x;
    }
SWIGINTERN std::vector< chrom_info,std::allocator< chrom_info > > *std_vector_Sl_chrom_info_Sg____getslice__(std::vector< chrom_info > *self,std::vector< chrom_info >::difference_type i,std::vector< chrom_info >::difference_type j){
      return swig::getslice(self, i, j, 1);
    }
SWIGINTERN void std_vector_Sl_chrom_info_Sg____setslice____SWIG_0(std::vector< chrom_info > *self,std::vector< chrom_info >::difference_type i,std::vector< chrom_info >::difference_type j,std::vector< chrom_info,std::allocator< chrom_info > > const &v=std::vector< chrom_info,std::allocator< chrom_info > >()){
      swig::setslice(self, i, j, 1, v);
    }
SWIGINTERN void std_vector_Sl_chrom_info_Sg____delslice__(std::vector< chrom_info > *self,std::vector< chrom_info >::difference_type i,std::vector< chrom_info >::difference_type j){
      swig::delslice(self, i, j, 1);
    }
SWIGINTERN void std_vector_Sl_chrom_info_Sg____delitem____SWIG_0(std::vector< chrom_info > *self,std::vector< chrom_info >::difference_type i){
      self->erase(swig::getpos(self,i));
    }
SWIGINTERN std::vector< chrom_info,std::allocator< chrom_info > > *std_vector_Sl_chrom_info_Sg____getitem____SWIG_0(std::vector< chrom_info > *self,PySliceObject *slice){
      Py_ssize_t i, j, step;
      if( !PySlice_Check(slice) ) {
        SWIG_Error(SWIG_TypeError, "Slice object expected.");
        return NULL;
      ...
      PySlice_GetIndices(SWIGPY_SLICE_ARG(slice), (Py_ssize_t)self->size(), &i, &j, &step);
      std::vector<chrom_info,std::allocator< chrom_info > >::difference_type id = i;
      std::vector<chrom_info,std::allocator< chrom_info > >::difference_type jd = j;
      return swig::getslice(self, id, jd, step);
    }
SWIGINTERN void std_vector_Sl_chrom_info_Sg____setitem____SWIG_0(std::vector< chrom_info > *self,PySliceObject *slice,std::vector< chrom_info,std::allocator< chrom_info > > const &v){
      Py_ssize_t i, j, step;
      if( !PySlice_Check(slice) ) {
        SWIG_Error(SWIG_TypeError, "Slice object expected.");
        return;
...
SWIGINTERN void std_vector_Sl_chrom_info_Sg____setitem____SWIG_1(std::vector< chrom_info > *self,PySliceObject *slice){
      Py_ssize_t i, j, step;
      if( !PySlice_Check(slice) ) {
        SWIG_Error(SWIG_TypeError, "Slice object expected.");
        return;
...
SWIGINTERN void std_vector_Sl_chrom_info_Sg____delitem____SWIG_1(std::vector< chrom_info > *self,PySliceObject *slice){
      Py_ssize_t i, j, step;
      if( !PySlice_Check(slice) ) {
        SWIG_Error(SWIG_TypeError, "Slice object expected.");
        return;
...
SWIGINTERN std::vector< chrom_info >::value_type const &std_vector_Sl_chrom_info_Sg____getitem____SWIG_1(std::vector< chrom_info > const *self,std::vector< chrom_info >::difference_type i){
      return *(swig::cgetpos(self, i));
    }
SWIGINTERN void std_vector_Sl_chrom_info_Sg____setitem____SWIG_2(std::vector< chrom_info > *self,std::vector< chrom_info >::difference_type i,std::vector< chrom_info >::value_type const &x){
      *(swig::getpos(self,i)) = x;
    }
SWIGINTERN void std_vector_Sl_chrom_info_Sg__append(std::vector< chrom_info > *self,std::vector< chrom_info >::value_type const &x){
      self->push_back(x);
    }
#ifdef __cplusplus
extern "C" {
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector_iterator(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  PyObject **arg2 = (PyObject **) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject * obj0 = 0 ;
  ...
  arg2 = &obj0;
  if (!PyArg_ParseTuple(args,(char *)"O:ConstStringViewVector_iterator",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector_iterator" "', argument " "1"" of type '" "std::vector< StringView > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< StringView > * >(argp1);
  result = (swig::SwigPyIterator *)std_vector_Sl_StringView_Sg__iterator(arg1,arg2);
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_swig__SwigPyIterator, SWIG_POINTER_OWN |  0 );
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector___nonzero__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ConstStringViewVector___nonzero__",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector___nonzero__" "', argument " "1"" of type '" "std::vector< StringView > const *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< StringView > * >(argp1);
  result = (bool)std_vector_Sl_StringView_Sg____nonzero__((std::vector< StringView > const *)arg1);
  resultobj = SWIG_From_bool(static_cast< bool >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector___bool__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ConstStringViewVector___bool__",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector___bool__" "', argument " "1"" of type '" "std::vector< StringView > const *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< StringView > * >(argp1);
  result = (bool)std_vector_Sl_StringView_Sg____bool__((std::vector< StringView > const *)arg1);
  resultobj = SWIG_From_bool(static_cast< bool >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector___len__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject * obj0 = 0 ;
  std::vector< StringView >::size_type result;
  
  if (!PyArg_ParseTuple(args,(char *)"O:ConstStringViewVector___len__",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector___len__" "', argument " "1"" of type '" "std::vector< StringView > const *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< StringView > * >(argp1);
  result = std_vector_Sl_StringView_Sg____len__((std::vector< StringView > const *)arg1);
  resultobj = SWIG_From_size_t(static_cast< size_t >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector_pop(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject * obj0 = 0 ;
  std::vector< StringView >::value_type result;
  
  if (!PyArg_ParseTuple(args,(char *)"O:ConstStringViewVector_pop",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector_pop" "', argument " "1"" of type '" "std::vector< StringView > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< StringView > * >(argp1);
  try {
    result = std_vector_Sl_StringView_Sg__pop(arg1);
  }
  catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  }
  
  resultobj = SWIG_NewPointerObj((new std::vector< StringView >::value_type(static_cast< const std::vector< StringView >::value_type& >(result))), SWIGTYPE_p_StringView, SWIG_POINTER_OWN |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector___getslice__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  std::vector< StringView >::difference_type arg2 ;
  std::vector< StringView >::difference_type arg3 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ptrdiff_t val2 ;
  int ecode2 = 0 ;
  ...
  PyObject * obj1 = 0 ;
  PyObject * obj2 = 0 ;
  std::vector< StringView,std::allocator< StringView > > *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"OOO:ConstStringViewVector___getslice__",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector___getslice__" "', argument " "1"" of type '" "std::vector< StringView > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< StringView > * >(argp1);
  ecode2 = SWIG_AsVal_ptrdiff_t(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "ConstStringViewVector___getslice__" "', argument " "2"" of type '" "std::vector< StringView >::difference_type""'");
  } 
  arg2 = static_cast< std::vector< StringView >::difference_type >(val2);
  ecode3 = SWIG_AsVal_ptrdiff_t(obj2, &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "ConstStringViewVector___getslice__" "', argument " "3"" of type '" "std::vector< StringView >::difference_type""'");
  } 
  arg3 = static_cast< std::vector< StringView >::difference_type >(val3);
  try {
    result = (std::vector< StringView,std::allocator< StringView > > *)std_vector_Sl_StringView_Sg____getslice__(arg1,arg2,arg3);
  }
  catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  }
  ...
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, SWIG_POINTER_OWN |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector___setslice____SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  std::vector< StringView >::difference_type arg2 ;
  std::vector< StringView >::difference_type arg3 ;
  std::vector< StringView,std::allocator< StringView > > *arg4 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ptrdiff_t val2 ;
  int ecode2 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOO:ConstStringViewVector___setslice__",&obj0,&obj1,&obj2,&obj3)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector___setslice__" "', argument " "1"" of type '" "std::vector< StringView > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< StringView > * >(argp1);
  ecode2 = SWIG_AsVal_ptrdiff_t(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "ConstStringViewVector___setslice__" "', argument " "2"" of type '" "std::vector< StringView >::difference_type""'");
  } 
  arg2 = static_cast< std::vector< StringView >::difference_type >(val2);
  ecode3 = SWIG_AsVal_ptrdiff_t(obj2, &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "ConstStringViewVector___setslice__" "', argument " "3"" of type '" "std::vector< StringView >::difference_type""'");
  } 
  arg3 = static_cast< std::vector< StringView >::difference_type >(val3);
  {
    std::vector<StringView,std::allocator< StringView > > *ptr = (std::vector<StringView,std::allocator< StringView > > *)0;
    res4 = swig::asptr(obj3, &ptr);
    if (!SWIG_IsOK(res4)) {
      SWIG_exception_fail(SWIG_ArgError(res4), "in method '" "ConstStringViewVector___setslice__" "', argument " "4"" of type '" "std::vector< StringView,std::allocator< StringView > > const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "ConstStringViewVector___setslice__" "', argument " "4"" of type '" "std::vector< StringView,std::allocator< StringView > > const &""'"); 
    }
    arg4 = ptr;
  }
  try {
    std_vector_Sl_StringView_Sg____setslice____SWIG_0(arg1,arg2,arg3,(std::vector< StringView,std::allocator< StringView > > const &)*arg4);
  }
  catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  }
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector___setslice____SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  std::vector< StringView >::difference_type arg2 ;
  std::vector< StringView >::difference_type arg3 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:ConstStringViewVector___setslice__",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector___setslice__" "', argument " "1"" of type '" "std::vector< StringView > *""'"); 
  }
  ...
  arg3 = static_cast< std::vector< StringView >::difference_type >(val3);
  try {
    std_vector_Sl_StringView_Sg____setslice____SWIG_0(arg1,arg2,arg3);
  }
  catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  }
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector___setslice__(PyObject *self, PyObject *args) {
  int argc;
  PyObject *argv[5];
  int ii;
  ...
  if (argc == 3) {
    int _v;
    int res = swig::asptr(argv[0], (std::vector<StringView,std::allocator< StringView > >**)(0));
    _v = SWIG_CheckState(res);
    if (_v) {
      {
        int res = SWIG_AsVal_ptrdiff_t(argv[1], NULL);
      ...
      if (_v) {
        ...
        if (_v) {
          return _wrap_ConstStringViewVector___setslice____SWIG_1(self, args);
        }
      }
    }
  }
  if (argc == 4) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          int res = swig::asptr(argv[3], (std::vector<StringView,std::allocator< StringView > >**)(0));
          _v = SWIG_CheckState(res);
          if (_v) {
            return _wrap_ConstStringViewVector___setslice____SWIG_0(self, args);
          }
        }
      }
    }
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'ConstStringViewVector___setslice__'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::vector< StringView >::__setslice__(std::vector< StringView >::difference_type,std::vector< StringView >::difference_type,std::vector< StringView,std::allocator< StringView > > const &)\n"
    "    std::vector< StringView >::__setslice__(std::vector< StringView >::difference_type,std::vector< StringView >::difference_type)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_ConstStringViewVector___delslice__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  std::vector< StringView >::difference_type arg2 ;
  std::vector< StringView >::difference_type arg3 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:ConstStringViewVector___delslice__",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector___delslice__" "', argument " "1"" of type '" "std::vector< StringView > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< StringView > * >(argp1);
  ecode2 = SWIG_AsVal_ptrdiff_t(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "ConstStringViewVector___delslice__" "', argument " "2"" of type '" "std::vector< StringView >::difference_type""'");
  } 
  arg2 = static_cast< std::vector< StringView >::difference_type >(val2);
  ecode3 = SWIG_AsVal_ptrdiff_t(obj2, &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "ConstStringViewVector___delslice__" "', argument " "3"" of type '" "std::vector< StringView >::difference_type""'");
  } 
  arg3 = static_cast< std::vector< StringView >::difference_type >(val3);
  try {
    std_vector_Sl_StringView_Sg____delslice__(arg1,arg2,arg3);
  }
  catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  }
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector___delitem____SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  std::vector< StringView >::difference_type arg2 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ConstStringViewVector___delitem__",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector___delitem__" "', argument " "1"" of type '" "std::vector< StringView > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< StringView > * >(argp1);
  ecode2 = SWIG_AsVal_ptrdiff_t(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "ConstStringViewVector___delitem__" "', argument " "2"" of type '" "std::vector< StringView >::difference_type""'");
  } 
  arg2 = static_cast< std::vector< StringView >::difference_type >(val2);
  try {
    std_vector_Sl_StringView_Sg____delitem____SWIG_0(arg1,arg2);
  }
  catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  }
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector___getitem____SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  PySliceObject *arg2 = (PySliceObject *) 0 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ConstStringViewVector___getitem__",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector___getitem__" "', argument " "1"" of type '" "std::vector< StringView > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< StringView > * >(argp1);
  {
    if (!PySlice_Check(obj1)) {
      SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "ConstStringViewVector___getitem__" "', argument " "2"" of type '" "PySliceObject *""'");
    }
    arg2 = (PySliceObject *) obj1;
  }
  try {
    result = (std::vector< StringView,std::allocator< StringView > > *)std_vector_Sl_StringView_Sg____getitem____SWIG_0(arg1,arg2);
  }
  catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  }
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector___setitem____SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  PySliceObject *arg2 = (PySliceObject *) 0 ;
  std::vector< StringView,std::allocator< StringView > > *arg3 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int res3 = SWIG_OLDOBJ ;
  PyObject * obj0 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:ConstStringViewVector___setitem__",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector___setitem__" "', argument " "1"" of type '" "std::vector< StringView > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< StringView > * >(argp1);
  {
    if (!PySlice_Check(obj1)) {
      SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "ConstStringViewVector___setitem__" "', argument " "2"" of type '" "PySliceObject *""'");
    }
    arg2 = (PySliceObject *) obj1;
  }
  {
    ...
    res3 = swig::asptr(obj2, &ptr);
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "ConstStringViewVector___setitem__" "', argument " "3"" of type '" "std::vector< StringView,std::allocator< StringView > > const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "ConstStringViewVector___setitem__" "', argument " "3"" of type '" "std::vector< StringView,std::allocator< StringView > > const &""'"); 
    }
    arg3 = ptr;
  }
  try {
    std_vector_Sl_StringView_Sg____setitem____SWIG_0(arg1,arg2,(std::vector< StringView,std::allocator< StringView > > const &)*arg3);
  }
  catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  }
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector___setitem____SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  PySliceObject *arg2 = (PySliceObject *) 0 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ConstStringViewVector___setitem__",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector___setitem__" "', argument " "1"" of type '" "std::vector< StringView > *""'"); 
  }
  ...
  try {
    std_vector_Sl_StringView_Sg____setitem____SWIG_1(arg1,arg2);
  }
  catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  }
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector___delitem____SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  PySliceObject *arg2 = (PySliceObject *) 0 ;
  void *argp1 = 0 ;
  ...
  {
    if (!PySlice_Check(obj1)) {
      SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "ConstStringViewVector___delitem__" "', argument " "2"" of type '" "PySliceObject *""'");
    }
    arg2 = (PySliceObject *) obj1;
  }
  try {
    std_vector_Sl_StringView_Sg____delitem____SWIG_1(arg1,arg2);
  }
  catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  }
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector___delitem__(PyObject *self, PyObject *args) {
  int argc;
  PyObject *argv[3];
  int ii;
  ...
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_ConstStringViewVector___delitem____SWIG_1(self, args);
      }
    }
  }
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_ConstStringViewVector___delitem____SWIG_0(self, args);
      }
    }
  }
  
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'ConstStringViewVector___delitem__'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::vector< StringView >::__delitem__(std::vector< StringView >::difference_type)\n"
    "    std::vector< StringView >::__delitem__(PySliceObject *)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_ConstStringViewVector___getitem____SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  std::vector< StringView >::difference_type arg2 ;
  void *argp1 = 0 ;
  ...
  PyObject * obj0 = 0 ;
  PyObject * obj1 = 0 ;
  std::vector< StringView >::value_type *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"OO:ConstStringViewVector___getitem__",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector___getitem__" "', argument " "1"" of type '" "std::vector< StringView > const *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< StringView > * >(argp1);
  ecode2 = SWIG_AsVal_ptrdiff_t(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "ConstStringViewVector___getitem__" "', argument " "2"" of type '" "std::vector< StringView >::difference_type""'");
  } 
  arg2 = static_cast< std::vector< StringView >::difference_type >(val2);
  try {
    result = (std::vector< StringView >::value_type *) &std_vector_Sl_StringView_Sg____getitem____SWIG_1((std::vector< StringView > const *)arg1,arg2);
  }
  catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  }
  
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_StringView, 0 |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector___getitem__(PyObject *self, PyObject *args) {
  int argc;
  PyObject *argv[3];
  int ii;
  ...
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_ConstStringViewVector___getitem____SWIG_0(self, args);
      }
    }
  }
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_ConstStringViewVector___getitem____SWIG_1(self, args);
      }
    }
  }
  
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'ConstStringViewVector___getitem__'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::vector< StringView >::__getitem__(PySliceObject *)\n"
    "    std::vector< StringView >::__getitem__(std::vector< StringView >::difference_type) const\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_ConstStringViewVector___setitem____SWIG_2(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  std::vector< StringView >::difference_type arg2 ;
  std::vector< StringView >::value_type *arg3 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ptrdiff_t val2 ;
  int ecode2 = 0 ;
  ...
  ecode2 = SWIG_AsVal_ptrdiff_t(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "ConstStringViewVector___setitem__" "', argument " "2"" of type '" "std::vector< StringView >::difference_type""'");
  } 
  arg2 = static_cast< std::vector< StringView >::difference_type >(val2);
  res3 = SWIG_ConvertPtr(obj2, &argp3, SWIGTYPE_p_StringView,  0  | 0);
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "ConstStringViewVector___setitem__" "', argument " "3"" of type '" "std::vector< StringView >::value_type const &""'"); 
  }
  if (!argp3) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "ConstStringViewVector___setitem__" "', argument " "3"" of type '" "std::vector< StringView >::value_type const &""'"); 
  }
  arg3 = reinterpret_cast< std::vector< StringView >::value_type * >(argp3);
  try {
    std_vector_Sl_StringView_Sg____setitem____SWIG_2(arg1,arg2,(StringView const &)*arg3);
  }
  catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  }
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector___setitem__(PyObject *self, PyObject *args) {
  int argc;
  PyObject *argv[4];
  int ii;
  ...
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_ConstStringViewVector___setitem____SWIG_1(self, args);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        int res = swig::asptr(argv[2], (std::vector<StringView,std::allocator< StringView > >**)(0));
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_ConstStringViewVector___setitem____SWIG_0(self, args);
        }
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        int res = SWIG_ConvertPtr(argv[2], 0, SWIGTYPE_p_StringView, 0);
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_ConstStringViewVector___setitem____SWIG_2(self, args);
        }
      }
    }
  }
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'ConstStringViewVector___setitem__'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::vector< StringView >::__setitem__(PySliceObject *,std::vector< StringView,std::allocator< StringView > > const &)\n"
    "    std::vector< StringView >::__setitem__(PySliceObject *)\n"
    "    std::vector< StringView >::__setitem__(std::vector< StringView >::difference_type,std::vector< StringView >::value_type const &)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_ConstStringViewVector_append(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  std::vector< StringView >::value_type *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  void *argp2 = 0 ;
  int res2 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ConstStringViewVector_append",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector_append" "', argument " "1"" of type '" "std::vector< StringView > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< StringView > * >(argp1);
  res2 = SWIG_ConvertPtr(obj1, &argp2, SWIGTYPE_p_StringView,  0  | 0);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "ConstStringViewVector_append" "', argument " "2"" of type '" "std::vector< StringView >::value_type const &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "ConstStringViewVector_append" "', argument " "2"" of type '" "std::vector< StringView >::value_type const &""'"); 
  }
  arg2 = reinterpret_cast< std::vector< StringView >::value_type * >(argp2);
  std_vector_Sl_StringView_Sg__append(arg1,(StringView const &)*arg2);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_new_ConstStringViewVector__SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)":new_ConstStringViewVector")) SWIG_fail;
  result = (std::vector< StringView > *)new std::vector< StringView >();
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, SWIG_POINTER_NEW |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_new_ConstStringViewVector__SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = 0 ;
  int res1 = SWIG_OLDOBJ ;
  PyObject * obj0 = 0 ;
  std::vector< StringView > *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"O:new_ConstStringViewVector",&obj0)) SWIG_fail;
  {
    std::vector<StringView,std::allocator< StringView > > *ptr = (std::vector<StringView,std::allocator< StringView > > *)0;
    res1 = swig::asptr(obj0, &ptr);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_ConstStringViewVector" "', argument " "1"" of type '" "std::vector< StringView > const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_ConstStringViewVector" "', argument " "1"" of type '" "std::vector< StringView > const &""'"); 
    }
    arg1 = ptr;
  }
  result = (std::vector< StringView > *)new std::vector< StringView >((std::vector< StringView > const &)*arg1);
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, SWIG_POINTER_NEW |  0 );
  if (SWIG_IsNewObj(res1)) delete arg1;
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector_empty(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ConstStringViewVector_empty",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector_empty" "', argument " "1"" of type '" "std::vector< StringView > const *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< StringView > * >(argp1);
  result = (bool)((std::vector< StringView > const *)arg1)->empty();
  resultobj = SWIG_From_bool(static_cast< bool >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector_size(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ConstStringViewVector_size",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector_size" "', argument " "1"" of type '" "std::vector< StringView > const *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< StringView > * >(argp1);
  result = ((std::vector< StringView > const *)arg1)->size();
  resultobj = SWIG_From_size_t(static_cast< size_t >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector_clear(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ConstStringViewVector_clear",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector_clear" "', argument " "1"" of type '" "std::vector< StringView > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< StringView > * >(argp1);
  (arg1)->clear();
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector_swap(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  std::vector< StringView > *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  void *argp2 = 0 ;
  int res2 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ConstStringViewVector_swap",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector_swap" "', argument " "1"" of type '" "std::vector< StringView > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< StringView > * >(argp1);
  res2 = SWIG_ConvertPtr(obj1, &argp2, SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "ConstStringViewVector_swap" "', argument " "2"" of type '" "std::vector< StringView > &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "ConstStringViewVector_swap" "', argument " "2"" of type '" "std::vector< StringView > &""'"); 
  }
  arg2 = reinterpret_cast< std::vector< StringView > * >(argp2);
  (arg1)->swap(*arg2);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector_get_allocator(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject * obj0 = 0 ;
  SwigValueWrapper< std::allocator< StringView > > result;
  
  if (!PyArg_ParseTuple(args,(char *)"O:ConstStringViewVector_get_allocator",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector_get_allocator" "', argument " "1"" of type '" "std::vector< StringView > const *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< StringView > * >(argp1);
  result = ((std::vector< StringView > const *)arg1)->get_allocator();
  resultobj = SWIG_NewPointerObj((new std::vector< StringView >::allocator_type(static_cast< const std::vector< StringView >::allocator_type& >(result))), SWIGTYPE_p_std__allocatorT_StringView_t, SWIG_POINTER_OWN |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector_begin(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject * obj0 = 0 ;
  std::vector< StringView >::iterator result;
  
  if (!PyArg_ParseTuple(args,(char *)"O:ConstStringViewVector_begin",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector_begin" "', argument " "1"" of type '" "std::vector< StringView > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< StringView > * >(argp1);
  result = (arg1)->begin();
  resultobj = SWIG_NewPointerObj(swig::make_output_iterator(static_cast< const std::vector< StringView >::iterator & >(result)),
    swig::SwigPyIterator::descriptor(),SWIG_POINTER_OWN);
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector_end(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ConstStringViewVector_end",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector_end" "', argument " "1"" of type '" "std::vector< StringView > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< StringView > * >(argp1);
  result = (arg1)->end();
  resultobj = SWIG_NewPointerObj(swig::make_output_iterator(static_cast< const std::vector< StringView >::iterator & >(result)),
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector_rbegin(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject * obj0 = 0 ;
  std::vector< StringView >::reverse_iterator result;
  
  if (!PyArg_ParseTuple(args,(char *)"O:ConstStringViewVector_rbegin",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector_rbegin" "', argument " "1"" of type '" "std::vector< StringView > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< StringView > * >(argp1);
  result = (arg1)->rbegin();
  resultobj = SWIG_NewPointerObj(swig::make_output_iterator(static_cast< const std::vector< StringView >::reverse_iterator & >(result)),
    swig::SwigPyIterator::descriptor(),SWIG_POINTER_OWN);
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector_rend(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ConstStringViewVector_rend",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector_rend" "', argument " "1"" of type '" "std::vector< StringView > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< StringView > * >(argp1);
  result = (arg1)->rend();
  resultobj = SWIG_NewPointerObj(swig::make_output_iterator(static_cast< const std::vector< StringView >::reverse_iterator & >(result)),
...
SWIGINTERN PyObject *_wrap_new_ConstStringViewVector__SWIG_2(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView >::size_type arg1 ;
  size_t val1 ;
  int ecode1 = 0 ;
  PyObject * obj0 = 0 ;
  std::vector< StringView > *result = 0 ;
  ...
  ecode1 = SWIG_AsVal_size_t(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "new_ConstStringViewVector" "', argument " "1"" of type '" "std::vector< StringView >::size_type""'");
  } 
  arg1 = static_cast< std::vector< StringView >::size_type >(val1);
  result = (std::vector< StringView > *)new std::vector< StringView >(arg1);
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, SWIG_POINTER_NEW |  0 );
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector_pop_back(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ConstStringViewVector_pop_back",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector_pop_back" "', argument " "1"" of type '" "std::vector< StringView > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< StringView > * >(argp1);
  (arg1)->pop_back();
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector_resize__SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  std::vector< StringView >::size_type arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  size_t val2 ;
  int ecode2 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ConstStringViewVector_resize",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector_resize" "', argument " "1"" of type '" "std::vector< StringView > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< StringView > * >(argp1);
  ecode2 = SWIG_AsVal_size_t(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "ConstStringViewVector_resize" "', argument " "2"" of type '" "std::vector< StringView >::size_type""'");
  } 
  arg2 = static_cast< std::vector< StringView >::size_type >(val2);
  (arg1)->resize(arg2);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector_erase__SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  std::vector< StringView >::iterator arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  swig::SwigPyIterator *iter2 = 0 ;
  int res2 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ConstStringViewVector_erase",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector_erase" "', argument " "1"" of type '" "std::vector< StringView > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< StringView > * >(argp1);
  res2 = SWIG_ConvertPtr(obj1, SWIG_as_voidptrptr(&iter2), swig::SwigPyIterator::descriptor(), 0);
  if (!SWIG_IsOK(res2) || !iter2) {
    SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "ConstStringViewVector_erase" "', argument " "2"" of type '" "std::vector< StringView >::iterator""'");
  } else {
    swig::SwigPyIterator_T<std::vector< StringView >::iterator > *iter_t = dynamic_cast<swig::SwigPyIterator_T<std::vector< StringView >::iterator > *>(iter2);
    if (iter_t) {
      arg2 = iter_t->get_current();
    } else {
      SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "ConstStringViewVector_erase" "', argument " "2"" of type '" "std::vector< StringView >::iterator""'");
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector_erase__SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  std::vector< StringView >::iterator arg2 ;
  std::vector< StringView >::iterator arg3 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  swig::SwigPyIterator *iter2 = 0 ;
  int res2 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:ConstStringViewVector_erase",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector_erase" "', argument " "1"" of type '" "std::vector< StringView > *""'"); 
  }
  ...
  res3 = SWIG_ConvertPtr(obj2, SWIG_as_voidptrptr(&iter3), swig::SwigPyIterator::descriptor(), 0);
  if (!SWIG_IsOK(res3) || !iter3) {
    SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "ConstStringViewVector_erase" "', argument " "3"" of type '" "std::vector< StringView >::iterator""'");
  } else {
    swig::SwigPyIterator_T<std::vector< StringView >::iterator > *iter_t = dynamic_cast<swig::SwigPyIterator_T<std::vector< StringView >::iterator > *>(iter3);
    if (iter_t) {
      arg3 = iter_t->get_current();
    } else {
      SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "ConstStringViewVector_erase" "', argument " "3"" of type '" "std::vector< StringView >::iterator""'");
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector_erase(PyObject *self, PyObject *args) {
  int argc;
  PyObject *argv[4];
  int ii;
  ...
  if (argc == 2) {
    ...
    if (_v) {
      swig::SwigPyIterator *iter = 0;
      int res = SWIG_ConvertPtr(argv[1], SWIG_as_voidptrptr(&iter), swig::SwigPyIterator::descriptor(), 0);
      _v = (SWIG_IsOK(res) && iter && (dynamic_cast<swig::SwigPyIterator_T<std::vector< StringView >::iterator > *>(iter) != 0));
      if (_v) {
        return _wrap_ConstStringViewVector_erase__SWIG_0(self, args);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = (SWIG_IsOK(res) && iter && (dynamic_cast<swig::SwigPyIterator_T<std::vector< StringView >::iterator > *>(iter) != 0));
        if (_v) {
          return _wrap_ConstStringViewVector_erase__SWIG_1(self, args);
        }
      }
    }
  }
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'ConstStringViewVector_erase'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::vector< StringView >::erase(std::vector< StringView >::iterator)\n"
    "    std::vector< StringView >::erase(std::vector< StringView >::iterator,std::vector< StringView >::iterator)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_new_ConstStringViewVector__SWIG_3(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView >::size_type arg1 ;
  std::vector< StringView >::value_type *arg2 = 0 ;
  size_t val1 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:new_ConstStringViewVector",&obj0,&obj1)) SWIG_fail;
  ecode1 = SWIG_AsVal_size_t(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "new_ConstStringViewVector" "', argument " "1"" of type '" "std::vector< StringView >::size_type""'");
  } 
  ...
  res2 = SWIG_ConvertPtr(obj1, &argp2, SWIGTYPE_p_StringView,  0  | 0);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "new_ConstStringViewVector" "', argument " "2"" of type '" "std::vector< StringView >::value_type const &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_ConstStringViewVector" "', argument " "2"" of type '" "std::vector< StringView >::value_type const &""'"); 
  }
  arg2 = reinterpret_cast< std::vector< StringView >::value_type * >(argp2);
  result = (std::vector< StringView > *)new std::vector< StringView >(arg1,(std::vector< StringView >::value_type const &)*arg2);
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, SWIG_POINTER_NEW |  0 );
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_new_ConstStringViewVector(PyObject *self, PyObject *args) {
  int argc;
  PyObject *argv[3];
  int ii;
  ...
  if (argc == 0) {
    return _wrap_new_ConstStringViewVector__SWIG_0(self, args);
  }
  if (argc == 1) {
    int _v;
    {
    ...
    if (_v) {
      return _wrap_new_ConstStringViewVector__SWIG_2(self, args);
    }
  }
  if (argc == 1) {
    int _v;
    ...
    _v = SWIG_CheckState(res);
    if (_v) {
      return _wrap_new_ConstStringViewVector__SWIG_1(self, args);
    }
  }
  if (argc == 2) {
    int _v;
    ...
    if (_v) {
      int res = SWIG_ConvertPtr(argv[1], 0, SWIGTYPE_p_StringView, 0);
      _v = SWIG_CheckState(res);
      if (_v) {
        return _wrap_new_ConstStringViewVector__SWIG_3(self, args);
      }
    }
  }
  
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'new_ConstStringViewVector'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::vector< StringView >::vector()\n"
    "    std::vector< StringView >::vector(std::vector< StringView > const &)\n"
    "    std::vector< StringView >::vector(std::vector< StringView >::size_type)\n"
    "    std::vector< StringView >::vector(std::vector< StringView >::size_type,std::vector< StringView >::value_type const &)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_ConstStringViewVector_push_back(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  std::vector< StringView >::value_type *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ConstStringViewVector_push_back",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector_push_back" "', argument " "1"" of type '" "std::vector< StringView > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< StringView > * >(argp1);
  res2 = SWIG_ConvertPtr(obj1, &argp2, SWIGTYPE_p_StringView,  0  | 0);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "ConstStringViewVector_push_back" "', argument " "2"" of type '" "std::vector< StringView >::value_type const &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "ConstStringViewVector_push_back" "', argument " "2"" of type '" "std::vector< StringView >::value_type const &""'"); 
  }
  arg2 = reinterpret_cast< std::vector< StringView >::value_type * >(argp2);
  (arg1)->push_back((std::vector< StringView >::value_type const &)*arg2);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector_front(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ConstStringViewVector_front",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector_front" "', argument " "1"" of type '" "std::vector< StringView > const *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< StringView > * >(argp1);
  result = (std::vector< StringView >::value_type *) &((std::vector< StringView > const *)arg1)->front();
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_StringView, 0 |  0 );
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector_back(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ConstStringViewVector_back",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector_back" "', argument " "1"" of type '" "std::vector< StringView > const *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< StringView > * >(argp1);
  result = (std::vector< StringView >::value_type *) &((std::vector< StringView > const *)arg1)->back();
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_StringView, 0 |  0 );
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector_assign(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  std::vector< StringView >::size_type arg2 ;
  std::vector< StringView >::value_type *arg3 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:ConstStringViewVector_assign",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector_assign" "', argument " "1"" of type '" "std::vector< StringView > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< StringView > * >(argp1);
  ecode2 = SWIG_AsVal_size_t(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "ConstStringViewVector_assign" "', argument " "2"" of type '" "std::vector< StringView >::size_type""'");
  } 
  arg2 = static_cast< std::vector< StringView >::size_type >(val2);
  res3 = SWIG_ConvertPtr(obj2, &argp3, SWIGTYPE_p_StringView,  0  | 0);
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "ConstStringViewVector_assign" "', argument " "3"" of type '" "std::vector< StringView >::value_type const &""'"); 
  }
  if (!argp3) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "ConstStringViewVector_assign" "', argument " "3"" of type '" "std::vector< StringView >::value_type const &""'"); 
  }
  arg3 = reinterpret_cast< std::vector< StringView >::value_type * >(argp3);
  (arg1)->assign(arg2,(std::vector< StringView >::value_type const &)*arg3);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector_resize__SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  std::vector< StringView >::size_type arg2 ;
  std::vector< StringView >::value_type *arg3 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:ConstStringViewVector_resize",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector_resize" "', argument " "1"" of type '" "std::vector< StringView > *""'"); 
  }
  ...
  res3 = SWIG_ConvertPtr(obj2, &argp3, SWIGTYPE_p_StringView,  0  | 0);
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "ConstStringViewVector_resize" "', argument " "3"" of type '" "std::vector< StringView >::value_type const &""'"); 
  }
  if (!argp3) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "ConstStringViewVector_resize" "', argument " "3"" of type '" "std::vector< StringView >::value_type const &""'"); 
  }
  arg3 = reinterpret_cast< std::vector< StringView >::value_type * >(argp3);
  (arg1)->resize(arg2,(std::vector< StringView >::value_type const &)*arg3);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector_resize(PyObject *self, PyObject *args) {
  int argc;
  PyObject *argv[4];
  int ii;
  ...
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_ConstStringViewVector_resize__SWIG_0(self, args);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_ConstStringViewVector_resize__SWIG_1(self, args);
        }
      }
    }
  }
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'ConstStringViewVector_resize'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::vector< StringView >::resize(std::vector< StringView >::size_type)\n"
    "    std::vector< StringView >::resize(std::vector< StringView >::size_type,std::vector< StringView >::value_type const &)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_ConstStringViewVector_insert__SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  std::vector< StringView >::iterator arg2 ;
  std::vector< StringView >::value_type *arg3 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:ConstStringViewVector_insert",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector_insert" "', argument " "1"" of type '" "std::vector< StringView > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< StringView > * >(argp1);
  res2 = SWIG_ConvertPtr(obj1, SWIG_as_voidptrptr(&iter2), swig::SwigPyIterator::descriptor(), 0);
  if (!SWIG_IsOK(res2) || !iter2) {
    SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "ConstStringViewVector_insert" "', argument " "2"" of type '" "std::vector< StringView >::iterator""'");
  } else {
    swig::SwigPyIterator_T<std::vector< StringView >::iterator > *iter_t = dynamic_cast<swig::SwigPyIterator_T<std::vector< StringView >::iterator > *>(iter2);
    if (iter_t) {
      arg2 = iter_t->get_current();
  ...
  res3 = SWIG_ConvertPtr(obj2, &argp3, SWIGTYPE_p_StringView,  0  | 0);
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "ConstStringViewVector_insert" "', argument " "3"" of type '" "std::vector< StringView >::value_type const &""'"); 
  }
  if (!argp3) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "ConstStringViewVector_insert" "', argument " "3"" of type '" "std::vector< StringView >::value_type const &""'"); 
  }
  arg3 = reinterpret_cast< std::vector< StringView >::value_type * >(argp3);
  result = (arg1)->insert(arg2,(std::vector< StringView >::value_type const &)*arg3);
  resultobj = SWIG_NewPointerObj(swig::make_output_iterator(static_cast< const std::vector< StringView >::iterator & >(result)),
    swig::SwigPyIterator::descriptor(),SWIG_POINTER_OWN);
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector_insert__SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  std::vector< StringView >::iterator arg2 ;
  std::vector< StringView >::size_type arg3 ;
  std::vector< StringView >::value_type *arg4 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  swig::SwigPyIterator *iter2 = 0 ;
  int res2 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOO:ConstStringViewVector_insert",&obj0,&obj1,&obj2,&obj3)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector_insert" "', argument " "1"" of type '" "std::vector< StringView > *""'"); 
  }
  ...
  ecode3 = SWIG_AsVal_size_t(obj2, &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "ConstStringViewVector_insert" "', argument " "3"" of type '" "std::vector< StringView >::size_type""'");
  } 
  arg3 = static_cast< std::vector< StringView >::size_type >(val3);
  res4 = SWIG_ConvertPtr(obj3, &argp4, SWIGTYPE_p_StringView,  0  | 0);
  if (!SWIG_IsOK(res4)) {
    SWIG_exception_fail(SWIG_ArgError(res4), "in method '" "ConstStringViewVector_insert" "', argument " "4"" of type '" "std::vector< StringView >::value_type const &""'"); 
  }
  if (!argp4) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "ConstStringViewVector_insert" "', argument " "4"" of type '" "std::vector< StringView >::value_type const &""'"); 
  }
  arg4 = reinterpret_cast< std::vector< StringView >::value_type * >(argp4);
  (arg1)->insert(arg2,arg3,(std::vector< StringView >::value_type const &)*arg4);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector_insert(PyObject *self, PyObject *args) {
  int argc;
  PyObject *argv[5];
  int ii;
  ...
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_ConstStringViewVector_insert__SWIG_0(self, args);
        }
      }
    }
  }
  if (argc == 4) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          int res = SWIG_ConvertPtr(argv[3], 0, SWIGTYPE_p_StringView, 0);
          _v = SWIG_CheckState(res);
          if (_v) {
            return _wrap_ConstStringViewVector_insert__SWIG_1(self, args);
          }
        }
      }
    }
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'ConstStringViewVector_insert'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::vector< StringView >::insert(std::vector< StringView >::iterator,std::vector< StringView >::value_type const &)\n"
    "    std::vector< StringView >::insert(std::vector< StringView >::iterator,std::vector< StringView >::size_type,std::vector< StringView >::value_type const &)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_ConstStringViewVector_reserve(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  std::vector< StringView >::size_type arg2 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ConstStringViewVector_reserve",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector_reserve" "', argument " "1"" of type '" "std::vector< StringView > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< StringView > * >(argp1);
  ecode2 = SWIG_AsVal_size_t(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "ConstStringViewVector_reserve" "', argument " "2"" of type '" "std::vector< StringView >::size_type""'");
  } 
  arg2 = static_cast< std::vector< StringView >::size_type >(val2);
  (arg1)->reserve(arg2);
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *_wrap_ConstStringViewVector_capacity(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ConstStringViewVector_capacity",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConstStringViewVector_capacity" "', argument " "1"" of type '" "std::vector< StringView > const *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< StringView > * >(argp1);
  result = ((std::vector< StringView > const *)arg1)->capacity();
  resultobj = SWIG_From_size_t(static_cast< size_t >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_delete_ConstStringViewVector(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< StringView > *arg1 = (std::vector< StringView > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:delete_ConstStringViewVector",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_ConstStringViewVector" "', argument " "1"" of type '" "std::vector< StringView > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< StringView > * >(argp1);
  delete arg1;
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *ConstStringViewVector_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!PyArg_ParseTuple(args,(char*)"O:swigregister", &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}

SWIGINTERN PyObject *_wrap_ChromInfoVector_iterator(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  PyObject **arg2 = (PyObject **) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject * obj0 = 0 ;
  ...
  arg2 = &obj0;
  if (!PyArg_ParseTuple(args,(char *)"O:ChromInfoVector_iterator",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector_iterator" "', argument " "1"" of type '" "std::vector< chrom_info > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< chrom_info > * >(argp1);
  result = (swig::SwigPyIterator *)std_vector_Sl_chrom_info_Sg__iterator(arg1,arg2);
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_swig__SwigPyIterator, SWIG_POINTER_OWN |  0 );
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_ChromInfoVector___nonzero__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ChromInfoVector___nonzero__",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector___nonzero__" "', argument " "1"" of type '" "std::vector< chrom_info > const *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< chrom_info > * >(argp1);
  result = (bool)std_vector_Sl_chrom_info_Sg____nonzero__((std::vector< chrom_info > const *)arg1);
  resultobj = SWIG_From_bool(static_cast< bool >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_ChromInfoVector___bool__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ChromInfoVector___bool__",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector___bool__" "', argument " "1"" of type '" "std::vector< chrom_info > const *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< chrom_info > * >(argp1);
  result = (bool)std_vector_Sl_chrom_info_Sg____bool__((std::vector< chrom_info > const *)arg1);
  resultobj = SWIG_From_bool(static_cast< bool >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_ChromInfoVector___len__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject * obj0 = 0 ;
  std::vector< chrom_info >::size_type result;
  
  if (!PyArg_ParseTuple(args,(char *)"O:ChromInfoVector___len__",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector___len__" "', argument " "1"" of type '" "std::vector< chrom_info > const *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< chrom_info > * >(argp1);
  result = std_vector_Sl_chrom_info_Sg____len__((std::vector< chrom_info > const *)arg1);
  resultobj = SWIG_From_size_t(static_cast< size_t >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_ChromInfoVector_pop(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject * obj0 = 0 ;
  std::vector< chrom_info >::value_type result;
  
  if (!PyArg_ParseTuple(args,(char *)"O:ChromInfoVector_pop",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector_pop" "', argument " "1"" of type '" "std::vector< chrom_info > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< chrom_info > * >(argp1);
  try {
    result = std_vector_Sl_chrom_info_Sg__pop(arg1);
  }
  catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  }
  
  resultobj = SWIG_NewPointerObj((new std::vector< chrom_info >::value_type(static_cast< const std::vector< chrom_info >::value_type& >(result))), SWIGTYPE_p_chrom_info, SWIG_POINTER_OWN |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_ChromInfoVector___getslice__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  std::vector< chrom_info >::difference_type arg2 ;
  std::vector< chrom_info >::difference_type arg3 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ptrdiff_t val2 ;
  int ecode2 = 0 ;
  ...
  PyObject * obj1 = 0 ;
  PyObject * obj2 = 0 ;
  std::vector< chrom_info,std::allocator< chrom_info > > *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"OOO:ChromInfoVector___getslice__",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector___getslice__" "', argument " "1"" of type '" "std::vector< chrom_info > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< chrom_info > * >(argp1);
  ecode2 = SWIG_AsVal_ptrdiff_t(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "ChromInfoVector___getslice__" "', argument " "2"" of type '" "std::vector< chrom_info >::difference_type""'");
  } 
  arg2 = static_cast< std::vector< chrom_info >::difference_type >(val2);
  ecode3 = SWIG_AsVal_ptrdiff_t(obj2, &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "ChromInfoVector___getslice__" "', argument " "3"" of type '" "std::vector< chrom_info >::difference_type""'");
  } 
  arg3 = static_cast< std::vector< chrom_info >::difference_type >(val3);
  try {
    result = (std::vector< chrom_info,std::allocator< chrom_info > > *)std_vector_Sl_chrom_info_Sg____getslice__(arg1,arg2,arg3);
  }
  catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  }
  ...
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, SWIG_POINTER_OWN |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_ChromInfoVector___setslice____SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  std::vector< chrom_info >::difference_type arg2 ;
  std::vector< chrom_info >::difference_type arg3 ;
  std::vector< chrom_info,std::allocator< chrom_info > > *arg4 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ptrdiff_t val2 ;
  int ecode2 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOO:ChromInfoVector___setslice__",&obj0,&obj1,&obj2,&obj3)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector___setslice__" "', argument " "1"" of type '" "std::vector< chrom_info > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< chrom_info > * >(argp1);
  ecode2 = SWIG_AsVal_ptrdiff_t(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "ChromInfoVector___setslice__" "', argument " "2"" of type '" "std::vector< chrom_info >::difference_type""'");
  } 
  arg2 = static_cast< std::vector< chrom_info >::difference_type >(val2);
  ecode3 = SWIG_AsVal_ptrdiff_t(obj2, &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "ChromInfoVector___setslice__" "', argument " "3"" of type '" "std::vector< chrom_info >::difference_type""'");
  } 
  arg3 = static_cast< std::vector< chrom_info >::difference_type >(val3);
  {
    std::vector<chrom_info,std::allocator< chrom_info > > *ptr = (std::vector<chrom_info,std::allocator< chrom_info > > *)0;
    res4 = swig::asptr(obj3, &ptr);
    if (!SWIG_IsOK(res4)) {
      SWIG_exception_fail(SWIG_ArgError(res4), "in method '" "ChromInfoVector___setslice__" "', argument " "4"" of type '" "std::vector< chrom_info,std::allocator< chrom_info > > const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "ChromInfoVector___setslice__" "', argument " "4"" of type '" "std::vector< chrom_info,std::allocator< chrom_info > > const &""'"); 
    }
    arg4 = ptr;
  }
  try {
    std_vector_Sl_chrom_info_Sg____setslice____SWIG_0(arg1,arg2,arg3,(std::vector< chrom_info,std::allocator< chrom_info > > const &)*arg4);
  }
  catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  }
...
SWIGINTERN PyObject *_wrap_ChromInfoVector___setslice____SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  std::vector< chrom_info >::difference_type arg2 ;
  std::vector< chrom_info >::difference_type arg3 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:ChromInfoVector___setslice__",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector___setslice__" "', argument " "1"" of type '" "std::vector< chrom_info > *""'"); 
  }
  ...
  arg3 = static_cast< std::vector< chrom_info >::difference_type >(val3);
  try {
    std_vector_Sl_chrom_info_Sg____setslice____SWIG_0(arg1,arg2,arg3);
  }
  catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  }
...
SWIGINTERN PyObject *_wrap_ChromInfoVector___setslice__(PyObject *self, PyObject *args) {
  int argc;
  PyObject *argv[5];
  int ii;
  ...
  if (argc == 3) {
    int _v;
    int res = swig::asptr(argv[0], (std::vector<chrom_info,std::allocator< chrom_info > >**)(0));
    _v = SWIG_CheckState(res);
    if (_v) {
      {
        int res = SWIG_AsVal_ptrdiff_t(argv[1], NULL);
      ...
      if (_v) {
        ...
        if (_v) {
          return _wrap_ChromInfoVector___setslice____SWIG_1(self, args);
        }
      }
    }
  }
  if (argc == 4) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          int res = swig::asptr(argv[3], (std::vector<chrom_info,std::allocator< chrom_info > >**)(0));
          _v = SWIG_CheckState(res);
          if (_v) {
            return _wrap_ChromInfoVector___setslice____SWIG_0(self, args);
          }
        }
      }
    }
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'ChromInfoVector___setslice__'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::vector< chrom_info >::__setslice__(std::vector< chrom_info >::difference_type,std::vector< chrom_info >::difference_type,std::vector< chrom_info,std::allocator< chrom_info > > const &)\n"
    "    std::vector< chrom_info >::__setslice__(std::vector< chrom_info >::difference_type,std::vector< chrom_info >::difference_type)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_ChromInfoVector___delslice__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  std::vector< chrom_info >::difference_type arg2 ;
  std::vector< chrom_info >::difference_type arg3 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:ChromInfoVector___delslice__",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector___delslice__" "', argument " "1"" of type '" "std::vector< chrom_info > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< chrom_info > * >(argp1);
  ecode2 = SWIG_AsVal_ptrdiff_t(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "ChromInfoVector___delslice__" "', argument " "2"" of type '" "std::vector< chrom_info >::difference_type""'");
  } 
  arg2 = static_cast< std::vector< chrom_info >::difference_type >(val2);
  ecode3 = SWIG_AsVal_ptrdiff_t(obj2, &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "ChromInfoVector___delslice__" "', argument " "3"" of type '" "std::vector< chrom_info >::difference_type""'");
  } 
  arg3 = static_cast< std::vector< chrom_info >::difference_type >(val3);
  try {
    std_vector_Sl_chrom_info_Sg____delslice__(arg1,arg2,arg3);
  }
  catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  }
...
SWIGINTERN PyObject *_wrap_ChromInfoVector___delitem____SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  std::vector< chrom_info >::difference_type arg2 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ChromInfoVector___delitem__",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector___delitem__" "', argument " "1"" of type '" "std::vector< chrom_info > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< chrom_info > * >(argp1);
  ecode2 = SWIG_AsVal_ptrdiff_t(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "ChromInfoVector___delitem__" "', argument " "2"" of type '" "std::vector< chrom_info >::difference_type""'");
  } 
  arg2 = static_cast< std::vector< chrom_info >::difference_type >(val2);
  try {
    std_vector_Sl_chrom_info_Sg____delitem____SWIG_0(arg1,arg2);
  }
  catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  }
...
SWIGINTERN PyObject *_wrap_ChromInfoVector___getitem____SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  PySliceObject *arg2 = (PySliceObject *) 0 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ChromInfoVector___getitem__",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector___getitem__" "', argument " "1"" of type '" "std::vector< chrom_info > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< chrom_info > * >(argp1);
  {
    if (!PySlice_Check(obj1)) {
      SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "ChromInfoVector___getitem__" "', argument " "2"" of type '" "PySliceObject *""'");
    }
    arg2 = (PySliceObject *) obj1;
  }
  try {
    result = (std::vector< chrom_info,std::allocator< chrom_info > > *)std_vector_Sl_chrom_info_Sg____getitem____SWIG_0(arg1,arg2);
  }
  catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  }
...
SWIGINTERN PyObject *_wrap_ChromInfoVector___setitem____SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  PySliceObject *arg2 = (PySliceObject *) 0 ;
  std::vector< chrom_info,std::allocator< chrom_info > > *arg3 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int res3 = SWIG_OLDOBJ ;
  PyObject * obj0 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:ChromInfoVector___setitem__",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector___setitem__" "', argument " "1"" of type '" "std::vector< chrom_info > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< chrom_info > * >(argp1);
  {
    if (!PySlice_Check(obj1)) {
      SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "ChromInfoVector___setitem__" "', argument " "2"" of type '" "PySliceObject *""'");
    }
    arg2 = (PySliceObject *) obj1;
  }
  {
    ...
    res3 = swig::asptr(obj2, &ptr);
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "ChromInfoVector___setitem__" "', argument " "3"" of type '" "std::vector< chrom_info,std::allocator< chrom_info > > const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "ChromInfoVector___setitem__" "', argument " "3"" of type '" "std::vector< chrom_info,std::allocator< chrom_info > > const &""'"); 
    }
    arg3 = ptr;
  }
  try {
    std_vector_Sl_chrom_info_Sg____setitem____SWIG_0(arg1,arg2,(std::vector< chrom_info,std::allocator< chrom_info > > const &)*arg3);
  }
  catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  }
...
SWIGINTERN PyObject *_wrap_ChromInfoVector___setitem____SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  PySliceObject *arg2 = (PySliceObject *) 0 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ChromInfoVector___setitem__",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector___setitem__" "', argument " "1"" of type '" "std::vector< chrom_info > *""'"); 
  }
  ...
  try {
    std_vector_Sl_chrom_info_Sg____setitem____SWIG_1(arg1,arg2);
  }
  catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  }
...
SWIGINTERN PyObject *_wrap_ChromInfoVector___delitem____SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  PySliceObject *arg2 = (PySliceObject *) 0 ;
  void *argp1 = 0 ;
  ...
  {
    if (!PySlice_Check(obj1)) {
      SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "ChromInfoVector___delitem__" "', argument " "2"" of type '" "PySliceObject *""'");
    }
    arg2 = (PySliceObject *) obj1;
  }
  try {
    std_vector_Sl_chrom_info_Sg____delitem____SWIG_1(arg1,arg2);
  }
  catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  }
...
SWIGINTERN PyObject *_wrap_ChromInfoVector___delitem__(PyObject *self, PyObject *args) {
  int argc;
  PyObject *argv[3];
  int ii;
  ...
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_ChromInfoVector___delitem____SWIG_1(self, args);
      }
    }
  }
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_ChromInfoVector___delitem____SWIG_0(self, args);
      }
    }
  }
  
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'ChromInfoVector___delitem__'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::vector< chrom_info >::__delitem__(std::vector< chrom_info >::difference_type)\n"
    "    std::vector< chrom_info >::__delitem__(PySliceObject *)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_ChromInfoVector___getitem____SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  std::vector< chrom_info >::difference_type arg2 ;
  void *argp1 = 0 ;
  ...
  PyObject * obj0 = 0 ;
  PyObject * obj1 = 0 ;
  std::vector< chrom_info >::value_type *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"OO:ChromInfoVector___getitem__",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector___getitem__" "', argument " "1"" of type '" "std::vector< chrom_info > const *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< chrom_info > * >(argp1);
  ecode2 = SWIG_AsVal_ptrdiff_t(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "ChromInfoVector___getitem__" "', argument " "2"" of type '" "std::vector< chrom_info >::difference_type""'");
  } 
  arg2 = static_cast< std::vector< chrom_info >::difference_type >(val2);
  try {
    result = (std::vector< chrom_info >::value_type *) &std_vector_Sl_chrom_info_Sg____getitem____SWIG_1((std::vector< chrom_info > const *)arg1,arg2);
  }
  catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  }
  
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_chrom_info, 0 |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_ChromInfoVector___getitem__(PyObject *self, PyObject *args) {
  int argc;
  PyObject *argv[3];
  int ii;
  ...
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_ChromInfoVector___getitem____SWIG_0(self, args);
      }
    }
  }
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_ChromInfoVector___getitem____SWIG_1(self, args);
      }
    }
  }
  
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'ChromInfoVector___getitem__'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::vector< chrom_info >::__getitem__(PySliceObject *)\n"
    "    std::vector< chrom_info >::__getitem__(std::vector< chrom_info >::difference_type) const\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_ChromInfoVector___setitem____SWIG_2(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  std::vector< chrom_info >::difference_type arg2 ;
  std::vector< chrom_info >::value_type *arg3 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ptrdiff_t val2 ;
  int ecode2 = 0 ;
  ...
  ecode2 = SWIG_AsVal_ptrdiff_t(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "ChromInfoVector___setitem__" "', argument " "2"" of type '" "std::vector< chrom_info >::difference_type""'");
  } 
  arg2 = static_cast< std::vector< chrom_info >::difference_type >(val2);
  res3 = SWIG_ConvertPtr(obj2, &argp3, SWIGTYPE_p_chrom_info,  0  | 0);
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "ChromInfoVector___setitem__" "', argument " "3"" of type '" "std::vector< chrom_info >::value_type const &""'"); 
  }
  if (!argp3) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "ChromInfoVector___setitem__" "', argument " "3"" of type '" "std::vector< chrom_info >::value_type const &""'"); 
  }
  arg3 = reinterpret_cast< std::vector< chrom_info >::value_type * >(argp3);
  try {
    std_vector_Sl_chrom_info_Sg____setitem____SWIG_2(arg1,arg2,(chrom_info const &)*arg3);
  }
  catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  }
...
SWIGINTERN PyObject *_wrap_ChromInfoVector___setitem__(PyObject *self, PyObject *args) {
  int argc;
  PyObject *argv[4];
  int ii;
  ...
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_ChromInfoVector___setitem____SWIG_1(self, args);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        int res = swig::asptr(argv[2], (std::vector<chrom_info,std::allocator< chrom_info > >**)(0));
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_ChromInfoVector___setitem____SWIG_0(self, args);
        }
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        int res = SWIG_ConvertPtr(argv[2], 0, SWIGTYPE_p_chrom_info, 0);
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_ChromInfoVector___setitem____SWIG_2(self, args);
        }
      }
    }
  }
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'ChromInfoVector___setitem__'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::vector< chrom_info >::__setitem__(PySliceObject *,std::vector< chrom_info,std::allocator< chrom_info > > const &)\n"
    "    std::vector< chrom_info >::__setitem__(PySliceObject *)\n"
    "    std::vector< chrom_info >::__setitem__(std::vector< chrom_info >::difference_type,std::vector< chrom_info >::value_type const &)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_ChromInfoVector_append(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  std::vector< chrom_info >::value_type *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  void *argp2 = 0 ;
  int res2 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ChromInfoVector_append",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector_append" "', argument " "1"" of type '" "std::vector< chrom_info > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< chrom_info > * >(argp1);
  res2 = SWIG_ConvertPtr(obj1, &argp2, SWIGTYPE_p_chrom_info,  0  | 0);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "ChromInfoVector_append" "', argument " "2"" of type '" "std::vector< chrom_info >::value_type const &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "ChromInfoVector_append" "', argument " "2"" of type '" "std::vector< chrom_info >::value_type const &""'"); 
  }
  arg2 = reinterpret_cast< std::vector< chrom_info >::value_type * >(argp2);
  std_vector_Sl_chrom_info_Sg__append(arg1,(chrom_info const &)*arg2);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_new_ChromInfoVector__SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)":new_ChromInfoVector")) SWIG_fail;
  result = (std::vector< chrom_info > *)new std::vector< chrom_info >();
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, SWIG_POINTER_NEW |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_new_ChromInfoVector__SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = 0 ;
  int res1 = SWIG_OLDOBJ ;
  PyObject * obj0 = 0 ;
  std::vector< chrom_info > *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"O:new_ChromInfoVector",&obj0)) SWIG_fail;
  {
    std::vector<chrom_info,std::allocator< chrom_info > > *ptr = (std::vector<chrom_info,std::allocator< chrom_info > > *)0;
    res1 = swig::asptr(obj0, &ptr);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_ChromInfoVector" "', argument " "1"" of type '" "std::vector< chrom_info > const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_ChromInfoVector" "', argument " "1"" of type '" "std::vector< chrom_info > const &""'"); 
    }
    arg1 = ptr;
  }
  result = (std::vector< chrom_info > *)new std::vector< chrom_info >((std::vector< chrom_info > const &)*arg1);
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, SWIG_POINTER_NEW |  0 );
  if (SWIG_IsNewObj(res1)) delete arg1;
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_ChromInfoVector_empty(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ChromInfoVector_empty",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector_empty" "', argument " "1"" of type '" "std::vector< chrom_info > const *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< chrom_info > * >(argp1);
  result = (bool)((std::vector< chrom_info > const *)arg1)->empty();
  resultobj = SWIG_From_bool(static_cast< bool >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_ChromInfoVector_size(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ChromInfoVector_size",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector_size" "', argument " "1"" of type '" "std::vector< chrom_info > const *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< chrom_info > * >(argp1);
  result = ((std::vector< chrom_info > const *)arg1)->size();
  resultobj = SWIG_From_size_t(static_cast< size_t >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_ChromInfoVector_clear(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ChromInfoVector_clear",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector_clear" "', argument " "1"" of type '" "std::vector< chrom_info > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< chrom_info > * >(argp1);
  (arg1)->clear();
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *_wrap_ChromInfoVector_swap(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  std::vector< chrom_info > *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  void *argp2 = 0 ;
  int res2 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ChromInfoVector_swap",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector_swap" "', argument " "1"" of type '" "std::vector< chrom_info > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< chrom_info > * >(argp1);
  res2 = SWIG_ConvertPtr(obj1, &argp2, SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "ChromInfoVector_swap" "', argument " "2"" of type '" "std::vector< chrom_info > &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "ChromInfoVector_swap" "', argument " "2"" of type '" "std::vector< chrom_info > &""'"); 
  }
  arg2 = reinterpret_cast< std::vector< chrom_info > * >(argp2);
  (arg1)->swap(*arg2);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_ChromInfoVector_get_allocator(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject * obj0 = 0 ;
  SwigValueWrapper< std::allocator< chrom_info > > result;
  
  if (!PyArg_ParseTuple(args,(char *)"O:ChromInfoVector_get_allocator",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector_get_allocator" "', argument " "1"" of type '" "std::vector< chrom_info > const *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< chrom_info > * >(argp1);
  result = ((std::vector< chrom_info > const *)arg1)->get_allocator();
  resultobj = SWIG_NewPointerObj((new std::vector< chrom_info >::allocator_type(static_cast< const std::vector< chrom_info >::allocator_type& >(result))), SWIGTYPE_p_std__allocatorT_chrom_info_t, SWIG_POINTER_OWN |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_ChromInfoVector_begin(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject * obj0 = 0 ;
  std::vector< chrom_info >::iterator result;
  
  if (!PyArg_ParseTuple(args,(char *)"O:ChromInfoVector_begin",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector_begin" "', argument " "1"" of type '" "std::vector< chrom_info > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< chrom_info > * >(argp1);
  result = (arg1)->begin();
  resultobj = SWIG_NewPointerObj(swig::make_output_iterator(static_cast< const std::vector< chrom_info >::iterator & >(result)),
    swig::SwigPyIterator::descriptor(),SWIG_POINTER_OWN);
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_ChromInfoVector_end(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ChromInfoVector_end",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector_end" "', argument " "1"" of type '" "std::vector< chrom_info > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< chrom_info > * >(argp1);
  result = (arg1)->end();
  resultobj = SWIG_NewPointerObj(swig::make_output_iterator(static_cast< const std::vector< chrom_info >::iterator & >(result)),
...
SWIGINTERN PyObject *_wrap_ChromInfoVector_rbegin(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject * obj0 = 0 ;
  std::vector< chrom_info >::reverse_iterator result;
  
  if (!PyArg_ParseTuple(args,(char *)"O:ChromInfoVector_rbegin",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector_rbegin" "', argument " "1"" of type '" "std::vector< chrom_info > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< chrom_info > * >(argp1);
  result = (arg1)->rbegin();
  resultobj = SWIG_NewPointerObj(swig::make_output_iterator(static_cast< const std::vector< chrom_info >::reverse_iterator & >(result)),
    swig::SwigPyIterator::descriptor(),SWIG_POINTER_OWN);
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_ChromInfoVector_rend(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ChromInfoVector_rend",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector_rend" "', argument " "1"" of type '" "std::vector< chrom_info > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< chrom_info > * >(argp1);
  result = (arg1)->rend();
  resultobj = SWIG_NewPointerObj(swig::make_output_iterator(static_cast< const std::vector< chrom_info >::reverse_iterator & >(result)),
...
SWIGINTERN PyObject *_wrap_new_ChromInfoVector__SWIG_2(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info >::size_type arg1 ;
  size_t val1 ;
  int ecode1 = 0 ;
  PyObject * obj0 = 0 ;
  std::vector< chrom_info > *result = 0 ;
  ...
  ecode1 = SWIG_AsVal_size_t(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "new_ChromInfoVector" "', argument " "1"" of type '" "std::vector< chrom_info >::size_type""'");
  } 
  arg1 = static_cast< std::vector< chrom_info >::size_type >(val1);
  result = (std::vector< chrom_info > *)new std::vector< chrom_info >(arg1);
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, SWIG_POINTER_NEW |  0 );
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_ChromInfoVector_pop_back(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ChromInfoVector_pop_back",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector_pop_back" "', argument " "1"" of type '" "std::vector< chrom_info > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< chrom_info > * >(argp1);
  (arg1)->pop_back();
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *_wrap_ChromInfoVector_resize__SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  std::vector< chrom_info >::size_type arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  size_t val2 ;
  int ecode2 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ChromInfoVector_resize",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector_resize" "', argument " "1"" of type '" "std::vector< chrom_info > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< chrom_info > * >(argp1);
  ecode2 = SWIG_AsVal_size_t(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "ChromInfoVector_resize" "', argument " "2"" of type '" "std::vector< chrom_info >::size_type""'");
  } 
  arg2 = static_cast< std::vector< chrom_info >::size_type >(val2);
  (arg1)->resize(arg2);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_ChromInfoVector_erase__SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  std::vector< chrom_info >::iterator arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  swig::SwigPyIterator *iter2 = 0 ;
  int res2 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ChromInfoVector_erase",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector_erase" "', argument " "1"" of type '" "std::vector< chrom_info > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< chrom_info > * >(argp1);
  res2 = SWIG_ConvertPtr(obj1, SWIG_as_voidptrptr(&iter2), swig::SwigPyIterator::descriptor(), 0);
  if (!SWIG_IsOK(res2) || !iter2) {
    SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "ChromInfoVector_erase" "', argument " "2"" of type '" "std::vector< chrom_info >::iterator""'");
  } else {
    swig::SwigPyIterator_T<std::vector< chrom_info >::iterator > *iter_t = dynamic_cast<swig::SwigPyIterator_T<std::vector< chrom_info >::iterator > *>(iter2);
    if (iter_t) {
      arg2 = iter_t->get_current();
    } else {
      SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "ChromInfoVector_erase" "', argument " "2"" of type '" "std::vector< chrom_info >::iterator""'");
...
SWIGINTERN PyObject *_wrap_ChromInfoVector_erase__SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  std::vector< chrom_info >::iterator arg2 ;
  std::vector< chrom_info >::iterator arg3 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  swig::SwigPyIterator *iter2 = 0 ;
  int res2 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:ChromInfoVector_erase",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector_erase" "', argument " "1"" of type '" "std::vector< chrom_info > *""'"); 
  }
  ...
  res3 = SWIG_ConvertPtr(obj2, SWIG_as_voidptrptr(&iter3), swig::SwigPyIterator::descriptor(), 0);
  if (!SWIG_IsOK(res3) || !iter3) {
    SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "ChromInfoVector_erase" "', argument " "3"" of type '" "std::vector< chrom_info >::iterator""'");
  } else {
    swig::SwigPyIterator_T<std::vector< chrom_info >::iterator > *iter_t = dynamic_cast<swig::SwigPyIterator_T<std::vector< chrom_info >::iterator > *>(iter3);
    if (iter_t) {
      arg3 = iter_t->get_current();
    } else {
      SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "ChromInfoVector_erase" "', argument " "3"" of type '" "std::vector< chrom_info >::iterator""'");
...
SWIGINTERN PyObject *_wrap_ChromInfoVector_erase(PyObject *self, PyObject *args) {
  int argc;
  PyObject *argv[4];
  int ii;
  ...
  if (argc == 2) {
    ...
    if (_v) {
      swig::SwigPyIterator *iter = 0;
      int res = SWIG_ConvertPtr(argv[1], SWIG_as_voidptrptr(&iter), swig::SwigPyIterator::descriptor(), 0);
      _v = (SWIG_IsOK(res) && iter && (dynamic_cast<swig::SwigPyIterator_T<std::vector< chrom_info >::iterator > *>(iter) != 0));
      if (_v) {
        return _wrap_ChromInfoVector_erase__SWIG_0(self, args);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = (SWIG_IsOK(res) && iter && (dynamic_cast<swig::SwigPyIterator_T<std::vector< chrom_info >::iterator > *>(iter) != 0));
        if (_v) {
          return _wrap_ChromInfoVector_erase__SWIG_1(self, args);
        }
      }
    }
  }
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'ChromInfoVector_erase'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::vector< chrom_info >::erase(std::vector< chrom_info >::iterator)\n"
    "    std::vector< chrom_info >::erase(std::vector< chrom_info >::iterator,std::vector< chrom_info >::iterator)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_new_ChromInfoVector__SWIG_3(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info >::size_type arg1 ;
  std::vector< chrom_info >::value_type *arg2 = 0 ;
  size_t val1 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:new_ChromInfoVector",&obj0,&obj1)) SWIG_fail;
  ecode1 = SWIG_AsVal_size_t(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "new_ChromInfoVector" "', argument " "1"" of type '" "std::vector< chrom_info >::size_type""'");
  } 
  ...
  res2 = SWIG_ConvertPtr(obj1, &argp2, SWIGTYPE_p_chrom_info,  0  | 0);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "new_ChromInfoVector" "', argument " "2"" of type '" "std::vector< chrom_info >::value_type const &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_ChromInfoVector" "', argument " "2"" of type '" "std::vector< chrom_info >::value_type const &""'"); 
  }
  arg2 = reinterpret_cast< std::vector< chrom_info >::value_type * >(argp2);
  result = (std::vector< chrom_info > *)new std::vector< chrom_info >(arg1,(std::vector< chrom_info >::value_type const &)*arg2);
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, SWIG_POINTER_NEW |  0 );
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_new_ChromInfoVector(PyObject *self, PyObject *args) {
  int argc;
  PyObject *argv[3];
  int ii;
  ...
  if (argc == 0) {
    return _wrap_new_ChromInfoVector__SWIG_0(self, args);
  }
  if (argc == 1) {
    int _v;
    {
    ...
    if (_v) {
      return _wrap_new_ChromInfoVector__SWIG_2(self, args);
    }
  }
  if (argc == 1) {
    int _v;
    ...
    _v = SWIG_CheckState(res);
    if (_v) {
      return _wrap_new_ChromInfoVector__SWIG_1(self, args);
    }
  }
  if (argc == 2) {
    int _v;
    ...
    if (_v) {
      int res = SWIG_ConvertPtr(argv[1], 0, SWIGTYPE_p_chrom_info, 0);
      _v = SWIG_CheckState(res);
      if (_v) {
        return _wrap_new_ChromInfoVector__SWIG_3(self, args);
      }
    }
  }
  
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'new_ChromInfoVector'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::vector< chrom_info >::vector()\n"
    "    std::vector< chrom_info >::vector(std::vector< chrom_info > const &)\n"
    "    std::vector< chrom_info >::vector(std::vector< chrom_info >::size_type)\n"
    "    std::vector< chrom_info >::vector(std::vector< chrom_info >::size_type,std::vector< chrom_info >::value_type const &)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_ChromInfoVector_push_back(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  std::vector< chrom_info >::value_type *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ChromInfoVector_push_back",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector_push_back" "', argument " "1"" of type '" "std::vector< chrom_info > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< chrom_info > * >(argp1);
  res2 = SWIG_ConvertPtr(obj1, &argp2, SWIGTYPE_p_chrom_info,  0  | 0);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "ChromInfoVector_push_back" "', argument " "2"" of type '" "std::vector< chrom_info >::value_type const &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "ChromInfoVector_push_back" "', argument " "2"" of type '" "std::vector< chrom_info >::value_type const &""'"); 
  }
  arg2 = reinterpret_cast< std::vector< chrom_info >::value_type * >(argp2);
  (arg1)->push_back((std::vector< chrom_info >::value_type const &)*arg2);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_ChromInfoVector_front(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ChromInfoVector_front",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector_front" "', argument " "1"" of type '" "std::vector< chrom_info > const *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< chrom_info > * >(argp1);
  result = (std::vector< chrom_info >::value_type *) &((std::vector< chrom_info > const *)arg1)->front();
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_chrom_info, 0 |  0 );
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_ChromInfoVector_back(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ChromInfoVector_back",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector_back" "', argument " "1"" of type '" "std::vector< chrom_info > const *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< chrom_info > * >(argp1);
  result = (std::vector< chrom_info >::value_type *) &((std::vector< chrom_info > const *)arg1)->back();
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_chrom_info, 0 |  0 );
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_ChromInfoVector_assign(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  std::vector< chrom_info >::size_type arg2 ;
  std::vector< chrom_info >::value_type *arg3 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:ChromInfoVector_assign",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector_assign" "', argument " "1"" of type '" "std::vector< chrom_info > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< chrom_info > * >(argp1);
  ecode2 = SWIG_AsVal_size_t(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "ChromInfoVector_assign" "', argument " "2"" of type '" "std::vector< chrom_info >::size_type""'");
  } 
  arg2 = static_cast< std::vector< chrom_info >::size_type >(val2);
  res3 = SWIG_ConvertPtr(obj2, &argp3, SWIGTYPE_p_chrom_info,  0  | 0);
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "ChromInfoVector_assign" "', argument " "3"" of type '" "std::vector< chrom_info >::value_type const &""'"); 
  }
  if (!argp3) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "ChromInfoVector_assign" "', argument " "3"" of type '" "std::vector< chrom_info >::value_type const &""'"); 
  }
  arg3 = reinterpret_cast< std::vector< chrom_info >::value_type * >(argp3);
  (arg1)->assign(arg2,(std::vector< chrom_info >::value_type const &)*arg3);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_ChromInfoVector_resize__SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  std::vector< chrom_info >::size_type arg2 ;
  std::vector< chrom_info >::value_type *arg3 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:ChromInfoVector_resize",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector_resize" "', argument " "1"" of type '" "std::vector< chrom_info > *""'"); 
  }
  ...
  res3 = SWIG_ConvertPtr(obj2, &argp3, SWIGTYPE_p_chrom_info,  0  | 0);
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "ChromInfoVector_resize" "', argument " "3"" of type '" "std::vector< chrom_info >::value_type const &""'"); 
  }
  if (!argp3) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "ChromInfoVector_resize" "', argument " "3"" of type '" "std::vector< chrom_info >::value_type const &""'"); 
  }
  arg3 = reinterpret_cast< std::vector< chrom_info >::value_type * >(argp3);
  (arg1)->resize(arg2,(std::vector< chrom_info >::value_type const &)*arg3);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_ChromInfoVector_resize(PyObject *self, PyObject *args) {
  int argc;
  PyObject *argv[4];
  int ii;
  ...
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_ChromInfoVector_resize__SWIG_0(self, args);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_ChromInfoVector_resize__SWIG_1(self, args);
        }
      }
    }
  }
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'ChromInfoVector_resize'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::vector< chrom_info >::resize(std::vector< chrom_info >::size_type)\n"
    "    std::vector< chrom_info >::resize(std::vector< chrom_info >::size_type,std::vector< chrom_info >::value_type const &)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_ChromInfoVector_insert__SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  std::vector< chrom_info >::iterator arg2 ;
  std::vector< chrom_info >::value_type *arg3 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:ChromInfoVector_insert",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector_insert" "', argument " "1"" of type '" "std::vector< chrom_info > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< chrom_info > * >(argp1);
  res2 = SWIG_ConvertPtr(obj1, SWIG_as_voidptrptr(&iter2), swig::SwigPyIterator::descriptor(), 0);
  if (!SWIG_IsOK(res2) || !iter2) {
    SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "ChromInfoVector_insert" "', argument " "2"" of type '" "std::vector< chrom_info >::iterator""'");
  } else {
    swig::SwigPyIterator_T<std::vector< chrom_info >::iterator > *iter_t = dynamic_cast<swig::SwigPyIterator_T<std::vector< chrom_info >::iterator > *>(iter2);
    if (iter_t) {
      arg2 = iter_t->get_current();
  ...
  res3 = SWIG_ConvertPtr(obj2, &argp3, SWIGTYPE_p_chrom_info,  0  | 0);
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "ChromInfoVector_insert" "', argument " "3"" of type '" "std::vector< chrom_info >::value_type const &""'"); 
  }
  if (!argp3) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "ChromInfoVector_insert" "', argument " "3"" of type '" "std::vector< chrom_info >::value_type const &""'"); 
  }
  arg3 = reinterpret_cast< std::vector< chrom_info >::value_type * >(argp3);
  result = (arg1)->insert(arg2,(std::vector< chrom_info >::value_type const &)*arg3);
  resultobj = SWIG_NewPointerObj(swig::make_output_iterator(static_cast< const std::vector< chrom_info >::iterator & >(result)),
    swig::SwigPyIterator::descriptor(),SWIG_POINTER_OWN);
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_ChromInfoVector_insert__SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  std::vector< chrom_info >::iterator arg2 ;
  std::vector< chrom_info >::size_type arg3 ;
  std::vector< chrom_info >::value_type *arg4 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  swig::SwigPyIterator *iter2 = 0 ;
  int res2 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOO:ChromInfoVector_insert",&obj0,&obj1,&obj2,&obj3)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector_insert" "', argument " "1"" of type '" "std::vector< chrom_info > *""'"); 
  }
  ...
  ecode3 = SWIG_AsVal_size_t(obj2, &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "ChromInfoVector_insert" "', argument " "3"" of type '" "std::vector< chrom_info >::size_type""'");
  } 
  arg3 = static_cast< std::vector< chrom_info >::size_type >(val3);
  res4 = SWIG_ConvertPtr(obj3, &argp4, SWIGTYPE_p_chrom_info,  0  | 0);
  if (!SWIG_IsOK(res4)) {
    SWIG_exception_fail(SWIG_ArgError(res4), "in method '" "ChromInfoVector_insert" "', argument " "4"" of type '" "std::vector< chrom_info >::value_type const &""'"); 
  }
  if (!argp4) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "ChromInfoVector_insert" "', argument " "4"" of type '" "std::vector< chrom_info >::value_type const &""'"); 
  }
  arg4 = reinterpret_cast< std::vector< chrom_info >::value_type * >(argp4);
  (arg1)->insert(arg2,arg3,(std::vector< chrom_info >::value_type const &)*arg4);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_ChromInfoVector_insert(PyObject *self, PyObject *args) {
  int argc;
  PyObject *argv[5];
  int ii;
  ...
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_ChromInfoVector_insert__SWIG_0(self, args);
        }
      }
    }
  }
  if (argc == 4) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          int res = SWIG_ConvertPtr(argv[3], 0, SWIGTYPE_p_chrom_info, 0);
          _v = SWIG_CheckState(res);
          if (_v) {
            return _wrap_ChromInfoVector_insert__SWIG_1(self, args);
          }
        }
      }
    }
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'ChromInfoVector_insert'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::vector< chrom_info >::insert(std::vector< chrom_info >::iterator,std::vector< chrom_info >::value_type const &)\n"
    "    std::vector< chrom_info >::insert(std::vector< chrom_info >::iterator,std::vector< chrom_info >::size_type,std::vector< chrom_info >::value_type const &)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_ChromInfoVector_reserve(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  std::vector< chrom_info >::size_type arg2 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ChromInfoVector_reserve",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector_reserve" "', argument " "1"" of type '" "std::vector< chrom_info > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< chrom_info > * >(argp1);
  ecode2 = SWIG_AsVal_size_t(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "ChromInfoVector_reserve" "', argument " "2"" of type '" "std::vector< chrom_info >::size_type""'");
  } 
  arg2 = static_cast< std::vector< chrom_info >::size_type >(val2);
  (arg1)->reserve(arg2);
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *_wrap_ChromInfoVector_capacity(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ChromInfoVector_capacity",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ChromInfoVector_capacity" "', argument " "1"" of type '" "std::vector< chrom_info > const *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< chrom_info > * >(argp1);
  result = ((std::vector< chrom_info > const *)arg1)->capacity();
  resultobj = SWIG_From_size_t(static_cast< size_t >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_delete_ChromInfoVector(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< chrom_info > *arg1 = (std::vector< chrom_info > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:delete_ChromInfoVector",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_ChromInfoVector" "', argument " "1"" of type '" "std::vector< chrom_info > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< chrom_info > * >(argp1);
  delete arg1;
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *ChromInfoVector_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!PyArg_ParseTuple(args,(char*)"O:swigregister", &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}

SWIGINTERN PyObject *_wrap_genome_table_contigs_set(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  genome_table *arg1 = (genome_table *) 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:genome_table_contigs_set",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_genome_table, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "genome_table_contigs_set" "', argument " "1"" of type '" "genome_table *""'"); 
  }
  arg1 = reinterpret_cast< genome_table * >(argp1);
  res2 = SWIG_ConvertPtr(obj1, &argp2,SWIGTYPE_p_vectorT_std__string_std__allocatorT_std__string_t_t, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "genome_table_contigs_set" "', argument " "2"" of type '" "vector< string > *""'"); 
  }
  arg2 = reinterpret_cast< vector< string > * >(argp2);
  if (arg1) (arg1)->contigs = *arg2;
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_genome_table_contigs_get(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  genome_table *arg1 = (genome_table *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:genome_table_contigs_get",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_genome_table, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "genome_table_contigs_get" "', argument " "1"" of type '" "genome_table *""'"); 
  }
  arg1 = reinterpret_cast< genome_table * >(argp1);
  result = (vector< string > *)& ((arg1)->contigs);
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_vectorT_std__string_std__allocatorT_std__string_t_t, 0 |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_genome_table_contig_sizes_set(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  genome_table *arg1 = (genome_table *) 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:genome_table_contig_sizes_set",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_genome_table, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "genome_table_contig_sizes_set" "', argument " "1"" of type '" "genome_table *""'"); 
  }
  arg1 = reinterpret_cast< genome_table * >(argp1);
  res2 = SWIG_ConvertPtr(obj1, &argp2,SWIGTYPE_p_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "genome_table_contig_sizes_set" "', argument " "2"" of type '" "std::vector< unsigned int,std::allocator< unsigned int > > *""'"); 
  }
  arg2 = reinterpret_cast< std::vector< unsigned int,std::allocator< unsigned int > > * >(argp2);
  if (arg1) (arg1)->contig_sizes = *arg2;
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_genome_table_contig_sizes_get(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  genome_table *arg1 = (genome_table *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:genome_table_contig_sizes_get",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_genome_table, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "genome_table_contig_sizes_get" "', argument " "1"" of type '" "genome_table *""'"); 
  }
  arg1 = reinterpret_cast< genome_table * >(argp1);
  result = (std::vector< unsigned int,std::allocator< unsigned int > > *)& ((arg1)->contig_sizes);
...
SWIGINTERN PyObject *_wrap_new_genome_table__SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  genome_table *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)":new_genome_table")) SWIG_fail;
  result = (genome_table *)new genome_table();
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_genome_table, SWIG_POINTER_NEW |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_new_genome_table__SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::string arg1 ;
  PyObject * obj0 = 0 ;
  genome_table *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"O:new_genome_table",&obj0)) SWIG_fail;
  {
    std::string *ptr = (std::string *)0;
    int res = SWIG_AsPtr_std_string(obj0, &ptr);
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), "in method '" "new_genome_table" "', argument " "1"" of type '" "std::string""'"); 
    }
    arg1 = *ptr;
    if (SWIG_IsNewObj(res)) delete ptr;
  }
  result = (genome_table *)new genome_table(arg1);
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_genome_table, SWIG_POINTER_NEW |  0 );
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_new_genome_table(PyObject *self, PyObject *args) {
  int argc;
  PyObject *argv[2];
  int ii;
  ...
  if (argc == 0) {
    return _wrap_new_genome_table__SWIG_0(self, args);
  }
  if (argc == 1) {
    int _v;
    ...
    _v = SWIG_CheckState(res);
    if (_v) {
      return _wrap_new_genome_table__SWIG_1(self, args);
    }
  }
  
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'new_genome_table'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    genome_table::genome_table()\n"
    "    genome_table::genome_table(std::string)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_genome_table_load(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  genome_table *arg1 = (genome_table *) 0 ;
  std::string arg2 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:genome_table_load",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_genome_table, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "genome_table_load" "', argument " "1"" of type '" "genome_table *""'"); 
  }
  arg1 = reinterpret_cast< genome_table * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    ...
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), "in method '" "genome_table_load" "', argument " "2"" of type '" "std::string""'"); 
    }
    arg2 = *ptr;
    if (SWIG_IsNewObj(res)) delete ptr;
  }
...
SWIGINTERN PyObject *_wrap_genome_table_contig_ind(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  genome_table *arg1 = (genome_table *) 0 ;
  string *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:genome_table_contig_ind",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_genome_table, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "genome_table_contig_ind" "', argument " "1"" of type '" "genome_table *""'"); 
  }
  arg1 = reinterpret_cast< genome_table * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    res2 = SWIG_AsPtr_std_string(obj1, &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "genome_table_contig_ind" "', argument " "2"" of type '" "string const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "genome_table_contig_ind" "', argument " "2"" of type '" "string const &""'"); 
    }
    arg2 = ptr;
  }
  result = (int)(arg1)->contig_ind((string const &)*arg2);
  resultobj = SWIG_From_int(static_cast< int >(result));
  if (SWIG_IsNewObj(res2)) delete arg2;
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_genome_table_contig_size(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  genome_table *arg1 = (genome_table *) 0 ;
  string *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:genome_table_contig_size",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_genome_table, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "genome_table_contig_size" "', argument " "1"" of type '" "genome_table *""'"); 
  }
  arg1 = reinterpret_cast< genome_table * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    res2 = SWIG_AsPtr_std_string(obj1, &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "genome_table_contig_size" "', argument " "2"" of type '" "string const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "genome_table_contig_size" "', argument " "2"" of type '" "string const &""'"); 
    }
    arg2 = ptr;
  }
  result = (int)(arg1)->contig_size((string const &)*arg2);
  resultobj = SWIG_From_int(static_cast< int >(result));
  if (SWIG_IsNewObj(res2)) delete arg2;
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_genome_table_size(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  genome_table *arg1 = (genome_table *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:genome_table_size",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_genome_table, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "genome_table_size" "', argument " "1"" of type '" "genome_table const *""'"); 
  }
  arg1 = reinterpret_cast< genome_table * >(argp1);
  result = (unsigned int)((genome_table const *)arg1)->size();
  resultobj = SWIG_From_unsigned_SS_int(static_cast< unsigned int >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_genome_table_compare_coordinates__SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  genome_table *arg1 = (genome_table *) 0 ;
  string *arg2 = 0 ;
  int *arg3 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOOOOO:genome_table_compare_coordinates",&obj0,&obj1,&obj2,&obj3,&obj4,&obj5,&obj6)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_genome_table, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "genome_table_compare_coordinates" "', argument " "1"" of type '" "genome_table *""'"); 
  }
  arg1 = reinterpret_cast< genome_table * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    res2 = SWIG_AsPtr_std_string(obj1, &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "genome_table_compare_coordinates" "', argument " "2"" of type '" "string const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "genome_table_compare_coordinates" "', argument " "2"" of type '" "string const &""'"); 
    }
    arg2 = ptr;
  }
  ecode3 = SWIG_AsVal_int(obj2, &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "genome_table_compare_coordinates" "', argument " "3"" of type '" "int""'");
  } 
  temp3 = static_cast< int >(val3);
  arg3 = &temp3;
  ecode4 = SWIG_AsVal_char(obj3, &val4);
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "genome_table_compare_coordinates" "', argument " "4"" of type '" "char""'");
  } 
  temp4 = static_cast< char >(val4);
  arg4 = &temp4;
  {
    std::string *ptr = (std::string *)0;
    res5 = SWIG_AsPtr_std_string(obj4, &ptr);
    if (!SWIG_IsOK(res5)) {
      SWIG_exception_fail(SWIG_ArgError(res5), "in method '" "genome_table_compare_coordinates" "', argument " "5"" of type '" "string const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "genome_table_compare_coordinates" "', argument " "5"" of type '" "string const &""'"); 
    }
    arg5 = ptr;
  }
  ecode6 = SWIG_AsVal_int(obj5, &val6);
  if (!SWIG_IsOK(ecode6)) {
    SWIG_exception_fail(SWIG_ArgError(ecode6), "in method '" "genome_table_compare_coordinates" "', argument " "6"" of type '" "int""'");
  } 
  temp6 = static_cast< int >(val6);
  arg6 = &temp6;
  ecode7 = SWIG_AsVal_char(obj6, &val7);
  if (!SWIG_IsOK(ecode7)) {
    SWIG_exception_fail(SWIG_ArgError(ecode7), "in method '" "genome_table_compare_coordinates" "', argument " "7"" of type '" "char""'");
  } 
  temp7 = static_cast< char >(val7);
  arg7 = &temp7;
  result = (bool)(arg1)->compare_coordinates((string const &)*arg2,(int const &)*arg3,(char const &)*arg4,(string const &)*arg5,(int const &)*arg6,(char const &)*arg7);
  resultobj = SWIG_From_bool(static_cast< bool >(result));
  if (SWIG_IsNewObj(res2)) delete arg2;
...
SWIGINTERN PyObject *_wrap_genome_table_compare_coordinates__SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  genome_table *arg1 = (genome_table *) 0 ;
  StringView *arg2 = 0 ;
  int *arg3 = 0 ;
  ...
  res2 = SWIG_ConvertPtr(obj1, &argp2, SWIGTYPE_p_StringView,  0  | 0);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "genome_table_compare_coordinates" "', argument " "2"" of type '" "StringView const &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "genome_table_compare_coordinates" "', argument " "2"" of type '" "StringView const &""'"); 
  }
  arg2 = reinterpret_cast< StringView * >(argp2);
  ecode3 = SWIG_AsVal_int(obj2, &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "genome_table_compare_coordinates" "', argument " "3"" of type '" "int""'");
  } 
  ...
  temp4 = static_cast< char >(val4);
  arg4 = &temp4;
  res5 = SWIG_ConvertPtr(obj4, &argp5, SWIGTYPE_p_StringView,  0  | 0);
  if (!SWIG_IsOK(res5)) {
    SWIG_exception_fail(SWIG_ArgError(res5), "in method '" "genome_table_compare_coordinates" "', argument " "5"" of type '" "StringView const &""'"); 
  }
  if (!argp5) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "genome_table_compare_coordinates" "', argument " "5"" of type '" "StringView const &""'"); 
  }
  arg5 = reinterpret_cast< StringView * >(argp5);
  ecode6 = SWIG_AsVal_int(obj5, &val6);
  if (!SWIG_IsOK(ecode6)) {
    SWIG_exception_fail(SWIG_ArgError(ecode6), "in method '" "genome_table_compare_coordinates" "', argument " "6"" of type '" "int""'");
  } 
  ...
  temp7 = static_cast< char >(val7);
  arg7 = &temp7;
  result = (bool)(arg1)->compare_coordinates((StringView const &)*arg2,(int const &)*arg3,(char const &)*arg4,(StringView const &)*arg5,(int const &)*arg6,(char const &)*arg7);
  resultobj = SWIG_From_bool(static_cast< bool >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_genome_table_compare_coordinates__SWIG_2(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  genome_table *arg1 = (genome_table *) 0 ;
  StringView *arg2 = 0 ;
  int *arg3 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOOO:genome_table_compare_coordinates",&obj0,&obj1,&obj2,&obj3,&obj4)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_genome_table, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "genome_table_compare_coordinates" "', argument " "1"" of type '" "genome_table *""'"); 
  }
  ...
  res4 = SWIG_ConvertPtr(obj3, &argp4, SWIGTYPE_p_StringView,  0  | 0);
  if (!SWIG_IsOK(res4)) {
    SWIG_exception_fail(SWIG_ArgError(res4), "in method '" "genome_table_compare_coordinates" "', argument " "4"" of type '" "StringView const &""'"); 
  }
  if (!argp4) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "genome_table_compare_coordinates" "', argument " "4"" of type '" "StringView const &""'"); 
  }
  arg4 = reinterpret_cast< StringView * >(argp4);
  ecode5 = SWIG_AsVal_int(obj4, &val5);
  if (!SWIG_IsOK(ecode5)) {
    SWIG_exception_fail(SWIG_ArgError(ecode5), "in method '" "genome_table_compare_coordinates" "', argument " "5"" of type '" "int""'");
  } 
  temp5 = static_cast< int >(val5);
  arg5 = &temp5;
  result = (bool)(arg1)->compare_coordinates((StringView const &)*arg2,(int const &)*arg3,(StringView const &)*arg4,(int const &)*arg5);
  resultobj = SWIG_From_bool(static_cast< bool >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_genome_table_compare_coordinates(PyObject *self, PyObject *args) {
  int argc;
  PyObject *argv[8];
  int ii;
  ...
  if (argc == 5) {
    int _v;
    void *vptr = 0;
    int res = SWIG_ConvertPtr(argv[0], &vptr, SWIGTYPE_p_genome_table, 0);
    _v = SWIG_CheckState(res);
    if (_v) {
      int res = SWIG_ConvertPtr(argv[1], 0, SWIGTYPE_p_StringView, 0);
      _v = SWIG_CheckState(res);
      if (_v) {
        ...
        if (_v) {
          ...
          if (_v) {
            ...
            if (_v) {
              return _wrap_genome_table_compare_coordinates__SWIG_2(self, args);
            }
          }
        }
      }
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          ...
          if (_v) {
            int res = SWIG_ConvertPtr(argv[4], 0, SWIGTYPE_p_StringView, 0);
            _v = SWIG_CheckState(res);
            if (_v) {
              {
              ...
              if (_v) {
                ...
                if (_v) {
                  return _wrap_genome_table_compare_coordinates__SWIG_1(self, args);
                }
              }
            }
          }
          ...
          if (_v) {
            ...
            if (_v) {
              ...
              if (_v) {
                ...
                if (_v) {
                  return _wrap_genome_table_compare_coordinates__SWIG_0(self, args);
                }
              }
            }
          }
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'genome_table_compare_coordinates'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    genome_table::compare_coordinates(string const &,int const &,char const &,string const &,int const &,char const &)\n"
    "    genome_table::compare_coordinates(StringView const &,int const &,char const &,StringView const &,int const &,char const &)\n"
    "    genome_table::compare_coordinates(StringView const &,int const &,StringView const &,int const &)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_delete_genome_table(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  genome_table *arg1 = (genome_table *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:delete_genome_table",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_genome_table, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_genome_table" "', argument " "1"" of type '" "genome_table *""'"); 
  }
  arg1 = reinterpret_cast< genome_table * >(argp1);
  delete arg1;
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *genome_table_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!PyArg_ParseTuple(args,(char*)"O:swigregister", &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_genome_table, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}

SWIGINTERN PyObject *_wrap_chrom_info_chrom_set(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  chrom_info *arg1 = (chrom_info *) 0 ;
  std::string *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int res2 = SWIG_OLDOBJ ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:chrom_info_chrom_set",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_chrom_info, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "chrom_info_chrom_set" "', argument " "1"" of type '" "chrom_info *""'"); 
  }
  arg1 = reinterpret_cast< chrom_info * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    res2 = SWIG_AsPtr_std_string(obj1, &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "chrom_info_chrom_set" "', argument " "2"" of type '" "std::string const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "chrom_info_chrom_set" "', argument " "2"" of type '" "std::string const &""'"); 
    }
    arg2 = ptr;
  }
...
SWIGINTERN PyObject *_wrap_chrom_info_chrom_get(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  chrom_info *arg1 = (chrom_info *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:chrom_info_chrom_get",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_chrom_info, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "chrom_info_chrom_get" "', argument " "1"" of type '" "chrom_info *""'"); 
  }
  arg1 = reinterpret_cast< chrom_info * >(argp1);
...
SWIGINTERN PyObject *_wrap_chrom_info_size_set(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  chrom_info *arg1 = (chrom_info *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:chrom_info_size_set",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_chrom_info, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "chrom_info_size_set" "', argument " "1"" of type '" "chrom_info *""'"); 
  }
  arg1 = reinterpret_cast< chrom_info * >(argp1);
  ecode2 = SWIG_AsVal_int(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "chrom_info_size_set" "', argument " "2"" of type '" "int""'");
  } 
...
SWIGINTERN PyObject *_wrap_chrom_info_size_get(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  chrom_info *arg1 = (chrom_info *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:chrom_info_size_get",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_chrom_info, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "chrom_info_size_get" "', argument " "1"" of type '" "chrom_info *""'"); 
  }
  arg1 = reinterpret_cast< chrom_info * >(argp1);
...
SWIGINTERN PyObject *_wrap_chrom_info_offset_set(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  chrom_info *arg1 = (chrom_info *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:chrom_info_offset_set",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_chrom_info, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "chrom_info_offset_set" "', argument " "1"" of type '" "chrom_info *""'"); 
  }
  arg1 = reinterpret_cast< chrom_info * >(argp1);
  ecode2 = SWIG_AsVal_int(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "chrom_info_offset_set" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
...
SWIGINTERN PyObject *_wrap_chrom_info_offset_get(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  chrom_info *arg1 = (chrom_info *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:chrom_info_offset_get",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_chrom_info, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "chrom_info_offset_get" "', argument " "1"" of type '" "chrom_info *""'"); 
  }
  arg1 = reinterpret_cast< chrom_info * >(argp1);
...
SWIGINTERN PyObject *_wrap_chrom_info_buckets_set(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  chrom_info *arg1 = (chrom_info *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:chrom_info_buckets_set",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_chrom_info, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "chrom_info_buckets_set" "', argument " "1"" of type '" "chrom_info *""'"); 
  }
  arg1 = reinterpret_cast< chrom_info * >(argp1);
  ecode2 = SWIG_AsVal_int(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "chrom_info_buckets_set" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
...
SWIGINTERN PyObject *_wrap_chrom_info_buckets_get(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  chrom_info *arg1 = (chrom_info *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:chrom_info_buckets_get",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_chrom_info, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "chrom_info_buckets_get" "', argument " "1"" of type '" "chrom_info *""'"); 
  }
  arg1 = reinterpret_cast< chrom_info * >(argp1);
  result = (int) ((arg1)->buckets);
  resultobj = SWIG_From_int(static_cast< int >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_new_chrom_info(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  chrom_info *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)":new_chrom_info")) SWIG_fail;
  result = (chrom_info *)new chrom_info();
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_chrom_info, SWIG_POINTER_NEW |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_delete_chrom_info(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  chrom_info *arg1 = (chrom_info *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:delete_chrom_info",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_chrom_info, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_chrom_info" "', argument " "1"" of type '" "chrom_info *""'"); 
  }
  arg1 = reinterpret_cast< chrom_info * >(argp1);
  delete arg1;
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *chrom_info_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!PyArg_ParseTuple(args,(char*)"O:swigregister", &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_chrom_info, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}

SWIGINTERN PyObject *_wrap_genome_hash_table_size(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  genome_hash_table *arg1 = (genome_hash_table *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject * obj0 = 0 ;
  int result;
  
  if (!PyArg_ParseTuple(args,(char *)"O:genome_hash_table_size",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_genome_hash_table, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "genome_hash_table_size" "', argument " "1"" of type '" "genome_hash_table *""'"); 
  }
  arg1 = reinterpret_cast< genome_hash_table * >(argp1);
  result = (int)(arg1)->size();
  resultobj = SWIG_From_int(static_cast< int >(result));
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_new_genome_hash_table(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  genome_table arg1 ;
  int arg2 ;
  void *argp1 ;
  ...
  PyObject * obj0 = 0 ;
  PyObject * obj1 = 0 ;
  genome_hash_table *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"OO:new_genome_hash_table",&obj0,&obj1)) SWIG_fail;
  {
    res1 = SWIG_ConvertPtr(obj0, &argp1, SWIGTYPE_p_genome_table,  0  | 0);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_genome_hash_table" "', argument " "1"" of type '" "genome_table""'"); 
    }  
    if (!argp1) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_genome_hash_table" "', argument " "1"" of type '" "genome_table""'");
    } else {
      genome_table * temp = reinterpret_cast< genome_table * >(argp1);
      arg1 = *temp;
  ...
  ecode2 = SWIG_AsVal_int(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "new_genome_hash_table" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  result = (genome_hash_table *)new genome_hash_table(arg1,arg2);
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_genome_hash_table, SWIG_POINTER_NEW |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_genome_hash_table_hash_value(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  genome_hash_table *arg1 = (genome_hash_table *) 0 ;
  std::string arg2 ;
  int arg3 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:genome_hash_table_hash_value",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_genome_hash_table, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "genome_hash_table_hash_value" "', argument " "1"" of type '" "genome_hash_table *""'"); 
  }
  arg1 = reinterpret_cast< genome_hash_table * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    int res = SWIG_AsPtr_std_string(obj1, &ptr);
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), "in method '" "genome_hash_table_hash_value" "', argument " "2"" of type '" "std::string""'"); 
    }
    arg2 = *ptr;
    if (SWIG_IsNewObj(res)) delete ptr;
  }
  ecode3 = SWIG_AsVal_int(obj2, &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "genome_hash_table_hash_value" "', argument " "3"" of type '" "int""'");
  } 
  arg3 = static_cast< int >(val3);
  result = (int)(arg1)->hash_value(arg2,arg3);
  resultobj = SWIG_From_int(static_cast< int >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_genome_hash_table_dist_to_left_boundary(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  genome_hash_table *arg1 = (genome_hash_table *) 0 ;
  std::string arg2 ;
  int arg3 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:genome_hash_table_dist_to_left_boundary",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_genome_hash_table, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "genome_hash_table_dist_to_left_boundary" "', argument " "1"" of type '" "genome_hash_table *""'"); 
  }
  arg1 = reinterpret_cast< genome_hash_table * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    int res = SWIG_AsPtr_std_string(obj1, &ptr);
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), "in method '" "genome_hash_table_dist_to_left_boundary" "', argument " "2"" of type '" "std::string""'"); 
    }
    arg2 = *ptr;
    if (SWIG_IsNewObj(res)) delete ptr;
  }
  ecode3 = SWIG_AsVal_int(obj2, &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "genome_hash_table_dist_to_left_boundary" "', argument " "3"" of type '" "int""'");
  } 
  arg3 = static_cast< int >(val3);
  result = (int)(arg1)->dist_to_left_boundary(arg2,arg3);
  resultobj = SWIG_From_int(static_cast< int >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_genome_hash_table_dist_to_right_boundary(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  genome_hash_table *arg1 = (genome_hash_table *) 0 ;
  std::string arg2 ;
  int arg3 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:genome_hash_table_dist_to_right_boundary",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_genome_hash_table, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "genome_hash_table_dist_to_right_boundary" "', argument " "1"" of type '" "genome_hash_table *""'"); 
  }
  arg1 = reinterpret_cast< genome_hash_table * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    int res = SWIG_AsPtr_std_string(obj1, &ptr);
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), "in method '" "genome_hash_table_dist_to_right_boundary" "', argument " "2"" of type '" "std::string""'"); 
    }
    arg2 = *ptr;
    if (SWIG_IsNewObj(res)) delete ptr;
  }
  ecode3 = SWIG_AsVal_int(obj2, &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "genome_hash_table_dist_to_right_boundary" "', argument " "3"" of type '" "int""'");
  } 
  arg3 = static_cast< int >(val3);
  result = (int)(arg1)->dist_to_right_boundary(arg2,arg3);
  resultobj = SWIG_From_int(static_cast< int >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_delete_genome_hash_table(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  genome_hash_table *arg1 = (genome_hash_table *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:delete_genome_hash_table",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_genome_hash_table, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_genome_hash_table" "', argument " "1"" of type '" "genome_hash_table *""'"); 
  }
  arg1 = reinterpret_cast< genome_hash_table * >(argp1);
  delete arg1;
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *genome_hash_table_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!PyArg_ParseTuple(args,(char*)"O:swigregister", &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_genome_hash_table, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}

SWIGINTERN PyObject *_wrap_split__SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  string *arg1 = 0 ;
  char arg2 ;
  int res1 = SWIG_OLDOBJ ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:split",&obj0,&obj1)) SWIG_fail;
  {
    ...
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "split" "', argument " "1"" of type '" "string const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "split" "', argument " "1"" of type '" "string const &""'"); 
    }
    arg1 = ptr;
  }
  ecode2 = SWIG_AsVal_char(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "split" "', argument " "2"" of type '" "char""'");
  } 
  arg2 = static_cast< char >(val2);
  result = split((std::string const &)*arg1,arg2);
...
SWIGINTERN PyObject *_wrap_split__SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  string *arg1 = 0 ;
  char arg2 ;
  vector< std::string,std::allocator< std::string > > *arg3 = 0 ;
  int res1 = SWIG_OLDOBJ ;
  char val2 ;
  int ecode2 = 0 ;
  void *argp3 = 0 ;
  ...
  arg2 = static_cast< char >(val2);
  res3 = SWIG_ConvertPtr(obj2, &argp3, SWIGTYPE_p_vectorT_std__string_std__allocatorT_std__string_t_t,  0 );
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "split" "', argument " "3"" of type '" "vector< std::string,std::allocator< std::string > > &""'"); 
  }
  if (!argp3) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "split" "', argument " "3"" of type '" "vector< std::string,std::allocator< std::string > > &""'"); 
  }
  arg3 = reinterpret_cast< vector< std::string,std::allocator< std::string > > * >(argp3);
...
SWIGINTERN PyObject *_wrap_split__SWIG_2(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  string *arg1 = 0 ;
  char arg2 ;
  vector< StringView,std::allocator< StringView > > *arg3 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  char val2 ;
  int ecode2 = 0 ;
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "split" "', argument " "1"" of type '" "string &""'"); 
  }
  if (!argp1) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "split" "', argument " "1"" of type '" "string &""'"); 
  }
  ...
  arg2 = static_cast< char >(val2);
  res3 = SWIG_ConvertPtr(obj2, &argp3, SWIGTYPE_p_vectorT_StringView_std__allocatorT_StringView_t_t,  0 );
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "split" "', argument " "3"" of type '" "vector< StringView,std::allocator< StringView > > &""'"); 
  }
  if (!argp3) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "split" "', argument " "3"" of type '" "vector< StringView,std::allocator< StringView > > &""'"); 
  }
  arg3 = reinterpret_cast< vector< StringView,std::allocator< StringView > > * >(argp3);
...
SWIGINTERN PyObject *_wrap_split__SWIG_3(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  StringView *arg1 = 0 ;
  char arg2 ;
  std::vector< StringView,std::allocator< StringView > > *arg3 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:split",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1, SWIGTYPE_p_StringView,  0  | 0);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "split" "', argument " "1"" of type '" "StringView const &""'"); 
  }
  if (!argp1) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "split" "', argument " "1"" of type '" "StringView const &""'"); 
  }
  arg1 = reinterpret_cast< StringView * >(argp1);
  ecode2 = SWIG_AsVal_char(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "split" "', argument " "2"" of type '" "char""'");
  } 
  arg2 = static_cast< char >(val2);
  res3 = SWIG_ConvertPtr(obj2, &argp3, SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t,  0 );
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "split" "', argument " "3"" of type '" "std::vector< StringView,std::allocator< StringView > > &""'"); 
  }
  if (!argp3) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "split" "', argument " "3"" of type '" "std::vector< StringView,std::allocator< StringView > > &""'"); 
  }
  arg3 = reinterpret_cast< std::vector< StringView,std::allocator< StringView > > * >(argp3);
  split((StringView const &)*arg1,arg2,*arg3);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_split(PyObject *self, PyObject *args) {
  ...
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_split__SWIG_0(self, args);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        void *vptr = 0;
        int res = SWIG_ConvertPtr(argv[2], &vptr, SWIGTYPE_p_vectorT_StringView_std__allocatorT_StringView_t_t, 0);
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_split__SWIG_2(self, args);
        }
      }
    }
  }
  if (argc == 3) {
    int _v;
    int res = SWIG_ConvertPtr(argv[0], 0, SWIGTYPE_p_StringView, 0);
    _v = SWIG_CheckState(res);
    if (_v) {
      {
        int res = SWIG_AsVal_char(argv[1], NULL);
      ...
      if (_v) {
        void *vptr = 0;
        int res = SWIG_ConvertPtr(argv[2], &vptr, SWIGTYPE_p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0);
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_split__SWIG_3(self, args);
        }
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        void *vptr = 0;
        int res = SWIG_ConvertPtr(argv[2], &vptr, SWIGTYPE_p_vectorT_std__string_std__allocatorT_std__string_t_t, 0);
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_split__SWIG_1(self, args);
        }
      }
    }
  }
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'split'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    split(string const &,char)\n"
    "    split(string const &,char,vector< std::string,std::allocator< std::string > > &)\n"
    "    split(string &,char,vector< StringView,std::allocator< StringView > > &)\n"
    "    split(StringView const &,char,std::vector< StringView,std::allocator< StringView > > &)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_get_string_count(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::ifstream *arg1 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:get_string_count",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1, SWIGTYPE_p_std__ifstream,  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "get_string_count" "', argument " "1"" of type '" "std::ifstream &""'"); 
  }
  if (!argp1) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "get_string_count" "', argument " "1"" of type '" "std::ifstream &""'"); 
  }
  arg1 = reinterpret_cast< std::ifstream * >(argp1);
  result = (unsigned int)get_string_count(*arg1);
  resultobj = SWIG_From_unsigned_SS_int(static_cast< unsigned int >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_chomp(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  string *arg1 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:chomp",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1, SWIGTYPE_p_std__string,  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "chomp" "', argument " "1"" of type '" "string &""'"); 
  }
  if (!argp1) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "chomp" "', argument " "1"" of type '" "string &""'"); 
  }
  arg1 = reinterpret_cast< string * >(argp1);
  chomp(*arg1);
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *_wrap_perc_file_length(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::ifstream *arg1 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:perc_file_length",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1, SWIGTYPE_p_std__ifstream,  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "perc_file_length" "', argument " "1"" of type '" "std::ifstream &""'"); 
  }
  if (!argp1) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "perc_file_length" "', argument " "1"" of type '" "std::ifstream &""'"); 
  }
  arg1 = reinterpret_cast< std::ifstream * >(argp1);
  result = perc_file_length(*arg1);
  resultobj = SWIG_NewPointerObj((new std::ios::pos_type(static_cast< const std::ios::pos_type& >(result))), SWIGTYPE_p_std__ios__pos_type, SWIG_POINTER_OWN |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_k_pow(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:k_pow",&obj0)) SWIG_fail;
  ecode1 = SWIG_AsVal_int(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "k_pow" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = static_cast< int >(val1);
  result = (int)k_pow(arg1);
  resultobj = SWIG_From_int(static_cast< int >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_long_k_pow(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:long_k_pow",&obj0)) SWIG_fail;
  ecode1 = SWIG_AsVal_int(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "long_k_pow" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = static_cast< int >(val1);
  result = (long)long_k_pow(arg1);
...
SWIGINTERN PyObject *_wrap_commify(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:commify",&obj0)) SWIG_fail;
  ecode1 = SWIG_AsVal_int(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "commify" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = static_cast< int >(val1);
  result = commify(arg1);
  resultobj = SWIG_From_std_string(static_cast< std::string >(result));
...
SWIGINTERN PyObject *_wrap_commify_long(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  long arg1 ;
  long val1 ;
  int ecode1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:commify_long",&obj0)) SWIG_fail;
  ecode1 = SWIG_AsVal_long(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "commify_long" "', argument " "1"" of type '" "long""'");
  } 
  arg1 = static_cast< long >(val1);
  result = commify_long(arg1);
  resultobj = SWIG_From_std_string(static_cast< std::string >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_read_wig(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  string *arg1 = 0 ;
  genome_table *arg2 = 0 ;
  vector< std::vector< float,std::allocator< float > >,std::allocator< std::vector< float,std::allocator< float > > > > *arg3 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  void *argp2 = 0 ;
  int res2 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:read_wig",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1, SWIGTYPE_p_std__string,  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "read_wig" "', argument " "1"" of type '" "string &""'"); 
  }
  if (!argp1) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "read_wig" "', argument " "1"" of type '" "string &""'"); 
  }
  arg1 = reinterpret_cast< string * >(argp1);
  res2 = SWIG_ConvertPtr(obj1, &argp2, SWIGTYPE_p_genome_table,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "read_wig" "', argument " "2"" of type '" "genome_table &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "read_wig" "', argument " "2"" of type '" "genome_table &""'"); 
  }
  arg2 = reinterpret_cast< genome_table * >(argp2);
  res3 = SWIG_ConvertPtr(obj2, &argp3, SWIGTYPE_p_vectorT_std__vectorT_float_std__allocatorT_float_t_t_std__allocatorT_std__vectorT_float_std__allocatorT_float_t_t_t_t,  0 );
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "read_wig" "', argument " "3"" of type '" "vector< std::vector< float,std::allocator< float > >,std::allocator< std::vector< float,std::allocator< float > > > > &""'"); 
  }
  if (!argp3) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "read_wig" "', argument " "3"" of type '" "vector< std::vector< float,std::allocator< float > >,std::allocator< std::vector< float,std::allocator< float > > > > &""'"); 
  }
  arg3 = reinterpret_cast< vector< std::vector< float,std::allocator< float > >,std::allocator< std::vector< float,std::allocator< float > > > > * >(argp3);
  read_wig(*arg1,*arg2,*arg3);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"ConstStringViewVector_iterator", _wrap_ConstStringViewVector_iterator, METH_VARARGS, NULL},
	 { (char *)"ConstStringViewVector___nonzero__", _wrap_ConstStringViewVector___nonzero__, METH_VARARGS, NULL},
	 { (char *)"ConstStringViewVector___bool__", _wrap_ConstStringViewVector___bool__, METH_VARARGS, NULL},
	 { (char *)"ConstStringViewVector___len__", _wrap_ConstStringViewVector___len__, METH_VARARGS, NULL},
	 { (char *)"ConstStringViewVector_pop", _wrap_ConstStringViewVector_pop, METH_VARARGS, NULL},
	 { (char *)"ConstStringViewVector___getslice__", _wrap_ConstStringViewVector___getslice__, METH_VARARGS, NULL},
	 { (char *)"ConstStringViewVector___setslice__", _wrap_ConstStringViewVector___setslice__, METH_VARARGS, NULL},
	 { (char *)"ConstStringViewVector___delslice__", _wrap_ConstStringViewVector___delslice__, METH_VARARGS, NULL},
	 { (char *)"ConstStringViewVector___delitem__", _wrap_ConstStringViewVector___delitem__, METH_VARARGS, NULL},
	 { (char *)"ConstStringViewVector___getitem__", _wrap_ConstStringViewVector___getitem__, METH_VARARGS, NULL},
	 { (char *)"ConstStringViewVector___setitem__", _wrap_ConstStringViewVector___setitem__, METH_VARARGS, NULL},
	 { (char *)"ConstStringViewVector_append", _wrap_ConstStringViewVector_append, METH_VARARGS, NULL},
	 { (char *)"ConstStringViewVector_empty", _wrap_ConstStringViewVector_empty, METH_VARARGS, NULL},
	 { (char *)"ConstStringViewVector_size", _wrap_ConstStringViewVector_size, METH_VARARGS, NULL},
	 { (char *)"ConstStringViewVector_clear", _wrap_ConstStringViewVector_clear, METH_VARARGS, NULL},
	 { (char *)"ConstStringViewVector_swap", _wrap_ConstStringViewVector_swap, METH_VARARGS, NULL},
	 { (char *)"ConstStringViewVector_get_allocator", _wrap_ConstStringViewVector_get_allocator, METH_VARARGS, NULL},
	 { (char *)"ConstStringViewVector_begin", _wrap_ConstStringViewVector_begin, METH_VARARGS, NULL},
	 { (char *)"ConstStringViewVector_end", _wrap_ConstStringViewVector_end, METH_VARARGS, NULL},
	 { (char *)"ConstStringViewVector_rbegin", _wrap_ConstStringViewVector_rbegin, METH_VARARGS, NULL},
	 { (char *)"ConstStringViewVector_rend", _wrap_ConstStringViewVector_rend, METH_VARARGS, NULL},
	 { (char *)"ConstStringViewVector_pop_back", _wrap_ConstStringViewVector_pop_back, METH_VARARGS, NULL},
	 { (char *)"ConstStringViewVector_erase", _wrap_ConstStringViewVector_erase, METH_VARARGS, NULL},
	 { (char *)"new_ConstStringViewVector", _wrap_new_ConstStringViewVector, METH_VARARGS, NULL},
	 { (char *)"ConstStringViewVector_push_back", _wrap_ConstStringViewVector_push_back, METH_VARARGS, NULL},
	 { (char *)"ConstStringViewVector_front", _wrap_ConstStringViewVector_front, METH_VARARGS, NULL},
	 { (char *)"ConstStringViewVector_back", _wrap_ConstStringViewVector_back, METH_VARARGS, NULL},
	 { (char *)"ConstStringViewVector_assign", _wrap_ConstStringViewVector_assign, METH_VARARGS, NULL},
	 { (char *)"ConstStringViewVector_resize", _wrap_ConstStringViewVector_resize, METH_VARARGS, NULL},
	 { (char *)"ConstStringViewVector_insert", _wrap_ConstStringViewVector_insert, METH_VARARGS, NULL},
	 { (char *)"ConstStringViewVector_reserve", _wrap_ConstStringViewVector_reserve, METH_VARARGS, NULL},
	 { (char *)"ConstStringViewVector_capacity", _wrap_ConstStringViewVector_capacity, METH_VARARGS, NULL},
	 { (char *)"delete_ConstStringViewVector", _wrap_delete_ConstStringViewVector, METH_VARARGS, NULL},
	 { (char *)"ConstStringViewVector_swigregister", ConstStringViewVector_swigregister, METH_VARARGS, NULL},
	 { (char *)"ChromInfoVector_iterator", _wrap_ChromInfoVector_iterator, METH_VARARGS, NULL},
	 { (char *)"ChromInfoVector___nonzero__", _wrap_ChromInfoVector___nonzero__, METH_VARARGS, NULL},
	 { (char *)"ChromInfoVector___bool__", _wrap_ChromInfoVector___bool__, METH_VARARGS, NULL},
	 { (char *)"ChromInfoVector___len__", _wrap_ChromInfoVector___len__, METH_VARARGS, NULL},
	 { (char *)"ChromInfoVector_pop", _wrap_ChromInfoVector_pop, METH_VARARGS, NULL},
	 { (char *)"ChromInfoVector___getslice__", _wrap_ChromInfoVector___getslice__, METH_VARARGS, NULL},
	 { (char *)"ChromInfoVector___setslice__", _wrap_ChromInfoVector___setslice__, METH_VARARGS, NULL},
	 { (char *)"ChromInfoVector___delslice__", _wrap_ChromInfoVector___delslice__, METH_VARARGS, NULL},
	 { (char *)"ChromInfoVector___delitem__", _wrap_ChromInfoVector___delitem__, METH_VARARGS, NULL},
	 { (char *)"ChromInfoVector___getitem__", _wrap_ChromInfoVector___getitem__, METH_VARARGS, NULL},
	 { (char *)"ChromInfoVector___setitem__", _wrap_ChromInfoVector___setitem__, METH_VARARGS, NULL},
	 { (char *)"ChromInfoVector_append", _wrap_ChromInfoVector_append, METH_VARARGS, NULL},
	 { (char *)"ChromInfoVector_empty", _wrap_ChromInfoVector_empty, METH_VARARGS, NULL},
	 { (char *)"ChromInfoVector_size", _wrap_ChromInfoVector_size, METH_VARARGS, NULL},
	 { (char *)"ChromInfoVector_clear", _wrap_ChromInfoVector_clear, METH_VARARGS, NULL},
	 { (char *)"ChromInfoVector_swap", _wrap_ChromInfoVector_swap, METH_VARARGS, NULL},
	 { (char *)"ChromInfoVector_get_allocator", _wrap_ChromInfoVector_get_allocator, METH_VARARGS, NULL},
	 { (char *)"ChromInfoVector_begin", _wrap_ChromInfoVector_begin, METH_VARARGS, NULL},
	 { (char *)"ChromInfoVector_end", _wrap_ChromInfoVector_end, METH_VARARGS, NULL},
	 { (char *)"ChromInfoVector_rbegin", _wrap_ChromInfoVector_rbegin, METH_VARARGS, NULL},
	 { (char *)"ChromInfoVector_rend", _wrap_ChromInfoVector_rend, METH_VARARGS, NULL},
	 { (char *)"ChromInfoVector_pop_back", _wrap_ChromInfoVector_pop_back, METH_VARARGS, NULL},
	 { (char *)"ChromInfoVector_erase", _wrap_ChromInfoVector_erase, METH_VARARGS, NULL},
	 { (char *)"new_ChromInfoVector", _wrap_new_ChromInfoVector, METH_VARARGS, NULL},
	 { (char *)"ChromInfoVector_push_back", _wrap_ChromInfoVector_push_back, METH_VARARGS, NULL},
	 { (char *)"ChromInfoVector_front", _wrap_ChromInfoVector_front, METH_VARARGS, NULL},
	 { (char *)"ChromInfoVector_back", _wrap_ChromInfoVector_back, METH_VARARGS, NULL},
	 { (char *)"ChromInfoVector_assign", _wrap_ChromInfoVector_assign, METH_VARARGS, NULL},
	 { (char *)"ChromInfoVector_resize", _wrap_ChromInfoVector_resize, METH_VARARGS, NULL},
	 { (char *)"ChromInfoVector_insert", _wrap_ChromInfoVector_insert, METH_VARARGS, NULL},
	 { (char *)"ChromInfoVector_reserve", _wrap_ChromInfoVector_reserve, METH_VARARGS, NULL},
	 { (char *)"ChromInfoVector_capacity", _wrap_ChromInfoVector_capacity, METH_VARARGS, NULL},
	 { (char *)"delete_ChromInfoVector", _wrap_delete_ChromInfoVector, METH_VARARGS, NULL},
	 { (char *)"ChromInfoVector_swigregister", ChromInfoVector_swigregister, METH_VARARGS, NULL},
	 { (char *)"genome_table_contigs_set", _wrap_genome_table_contigs_set, METH_VARARGS, NULL},
	 { (char *)"genome_table_contigs_get", _wrap_genome_table_contigs_get, METH_VARARGS, NULL},
	 { (char *)"genome_table_contig_sizes_set", _wrap_genome_table_contig_sizes_set, METH_VARARGS, NULL},
	 { (char *)"genome_table_contig_sizes_get", _wrap_genome_table_contig_sizes_get, METH_VARARGS, NULL},
	 { (char *)"new_genome_table", _wrap_new_genome_table, METH_VARARGS, NULL},
	 { (char *)"genome_table_load", _wrap_genome_table_load, METH_VARARGS, NULL},
	 { (char *)"genome_table_contig_ind", _wrap_genome_table_contig_ind, METH_VARARGS, NULL},
	 { (char *)"genome_table_contig_size", _wrap_genome_table_contig_size, METH_VARARGS, NULL},
	 { (char *)"genome_table_size", _wrap_genome_table_size, METH_VARARGS, NULL},
	 { (char *)"genome_table_compare_coordinates", _wrap_genome_table_compare_coordinates, METH_VARARGS, NULL},
	 { (char *)"delete_genome_table", _wrap_delete_genome_table, METH_VARARGS, NULL},
	 { (char *)"genome_table_swigregister", genome_table_swigregister, METH_VARARGS, NULL},
	 { (char *)"chrom_info_chrom_set", _wrap_chrom_info_chrom_set, METH_VARARGS, NULL},
	 { (char *)"chrom_info_chrom_get", _wrap_chrom_info_chrom_get, METH_VARARGS, NULL},
	 { (char *)"chrom_info_size_set", _wrap_chrom_info_size_set, METH_VARARGS, NULL},
	 { (char *)"chrom_info_size_get", _wrap_chrom_info_size_get, METH_VARARGS, NULL},
	 { (char *)"chrom_info_offset_set", _wrap_chrom_info_offset_set, METH_VARARGS, NULL},
	 { (char *)"chrom_info_offset_get", _wrap_chrom_info_offset_get, METH_VARARGS, NULL},
	 { (char *)"chrom_info_buckets_set", _wrap_chrom_info_buckets_set, METH_VARARGS, NULL},
	 { (char *)"chrom_info_buckets_get", _wrap_chrom_info_buckets_get, METH_VARARGS, NULL},
	 { (char *)"new_chrom_info", _wrap_new_chrom_info, METH_VARARGS, NULL},
	 { (char *)"delete_chrom_info", _wrap_delete_chrom_info, METH_VARARGS, NULL},
	 { (char *)"chrom_info_swigregister", chrom_info_swigregister, METH_VARARGS, NULL},
	 { (char *)"genome_hash_table_size", _wrap_genome_hash_table_size, METH_VARARGS, NULL},
	 { (char *)"new_genome_hash_table", _wrap_new_genome_hash_table, METH_VARARGS, NULL},
	 { (char *)"genome_hash_table_hash_value", _wrap_genome_hash_table_hash_value, METH_VARARGS, NULL},
	 { (char *)"genome_hash_table_dist_to_left_boundary", _wrap_genome_hash_table_dist_to_left_boundary, METH_VARARGS, NULL},
	 { (char *)"genome_hash_table_dist_to_right_boundary", _wrap_genome_hash_table_dist_to_right_boundary, METH_VARARGS, NULL},
	 { (char *)"delete_genome_hash_table", _wrap_delete_genome_hash_table, METH_VARARGS, NULL},
	 { (char *)"genome_hash_table_swigregister", genome_hash_table_swigregister, METH_VARARGS, NULL},
	 { (char *)"split", _wrap_split, METH_VARARGS, NULL},
	 { (char *)"get_string_count", _wrap_get_string_count, METH_VARARGS, NULL},
	 { (char *)"chomp", _wrap_chomp, METH_VARARGS, NULL},
	 { (char *)"perc_file_length", _wrap_perc_file_length, METH_VARARGS, NULL},
	 { (char *)"k_pow", _wrap_k_pow, METH_VARARGS, NULL},
	 { (char *)"long_k_pow", _wrap_long_k_pow, METH_VARARGS, NULL},
	 { (char *)"commify", _wrap_commify, METH_VARARGS, NULL},
	 { (char *)"commify_long", _wrap_commify_long, METH_VARARGS, NULL},
	 { (char *)"int2string", _wrap_int2string, METH_VARARGS, NULL},
	 { (char *)"read_wig", _wrap_read_wig, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
...
static swig_type_info _swigt__p_StringView = {"_p_StringView", "std::vector< StringView >::value_type *|StringView *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_allocator_type = {"_p_allocator_type", "allocator_type *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_chrom_info = {"_p_chrom_info", "chrom_info *|std::vector< chrom_info >::value_type *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_const_reference = {"_p_const_reference", "const_reference *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_difference_type = {"_p_difference_type", "difference_type *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_genome_hash_table = {"_p_genome_hash_table", "genome_hash_table *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_genome_table = {"_p_genome_table", "genome_table *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_p_PyObject = {"_p_p_PyObject", "PyObject **", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_reference = {"_p_reference", "reference *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_size_type = {"_p_size_type", "size_type *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_std__allocatorT_StringView_t = {"_p_std__allocatorT_StringView_t", "std::allocator< StringView > *|std::vector< StringView >::allocator_type *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_std__allocatorT_chrom_info_t = {"_p_std__allocatorT_chrom_info_t", "std::vector< chrom_info >::allocator_type *|std::allocator< chrom_info > *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_std__vectorT_StringView_std__allocatorT_StringView_t_t = {"_p_std__vectorT_StringView_std__allocatorT_StringView_t_t", "std::vector< StringView > *|std::vector< StringView,std::allocator< StringView > > *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t = {"_p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t", "std::vector< chrom_info,std::allocator< chrom_info > > *|std::vector< chrom_info > *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_vectorT_StringView_std__allocatorT_StringView_t_t = {"_p_vectorT_StringView_std__allocatorT_StringView_t_t", "vector< StringView,std::allocator< StringView > > *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_vectorT_std__string_std__allocatorT_std__string_t_t = {"_p_vectorT_std__string_std__allocatorT_std__string_t_t", "vector< std::string,std::allocator< std::string > > *|vector< std::string > *|vector< string > *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_vectorT_std__vectorT_float_std__allocatorT_float_t_t_std__allocatorT_std__vectorT_float_std__allocatorT_float_t_t_t_t = {"_p_vectorT_std__vectorT_float_std__allocatorT_float_t_t_std__allocatorT_std__vectorT_float_std__allocatorT_float_t_t_t_t", "vector< std::vector< float,std::allocator< float > >,std::allocator< std::vector< float,std::allocator< float > > > > *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_StringView,
  &_swigt__p_allocator_type,
  &_swigt__p_char,
  &_swigt__p_chrom_info,
  &_swigt__p_const_reference,
  &_swigt__p_difference_type,
  &_swigt__p_genome_hash_table,
  &_swigt__p_genome_table,
  &_swigt__p_p_PyObject,
  &_swigt__p_reference,
  &_swigt__p_size_type,
  &_swigt__p_std__allocatorT_StringView_t,
  &_swigt__p_std__allocatorT_char_const_p_t,
  &_swigt__p_std__allocatorT_chrom_info_t,
  ...
  &_swigt__p_std__vectorT_StringView_std__allocatorT_StringView_t_t,
  ...
  &_swigt__p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t,
  ...
  &_swigt__p_vectorT_StringView_std__allocatorT_StringView_t_t,
  &_swigt__p_vectorT_std__string_std__allocatorT_std__string_t_t,
  &_swigt__p_vectorT_std__vectorT_float_std__allocatorT_float_t_t_std__allocatorT_std__vectorT_float_std__allocatorT_float_t_t_t_t,
};

static swig_cast_info _swigc__p_StringView[] = {  {&_swigt__p_StringView, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_allocator_type[] = {  {&_swigt__p_allocator_type, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_chrom_info[] = {  {&_swigt__p_chrom_info, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_const_reference[] = {  {&_swigt__p_const_reference, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_difference_type[] = {  {&_swigt__p_difference_type, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_genome_hash_table[] = {  {&_swigt__p_genome_hash_table, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_genome_table[] = {  {&_swigt__p_genome_table, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_p_PyObject[] = {  {&_swigt__p_p_PyObject, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_reference[] = {  {&_swigt__p_reference, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_size_type[] = {  {&_swigt__p_size_type, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_std__allocatorT_StringView_t[] = {  {&_swigt__p_std__allocatorT_StringView_t, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_std__allocatorT_char_const_p_t[] = {  {&_swigt__p_std__allocatorT_char_const_p_t, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_std__allocatorT_chrom_info_t[] = {  {&_swigt__p_std__allocatorT_chrom_info_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_std__vectorT_StringView_std__allocatorT_StringView_t_t[] = {  {&_swigt__p_std__vectorT_StringView_std__allocatorT_StringView_t_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t[] = {  {&_swigt__p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_vectorT_StringView_std__allocatorT_StringView_t_t[] = {  {&_swigt__p_vectorT_StringView_std__allocatorT_StringView_t_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_vectorT_std__vectorT_float_std__allocatorT_float_t_t_std__allocatorT_std__vectorT_float_std__allocatorT_float_t_t_t_t[] = {  {&_swigt__p_vectorT_std__vectorT_float_std__allocatorT_float_t_t_std__allocatorT_std__vectorT_float_std__allocatorT_float_t_t_t_t, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_StringView,
  _swigc__p_allocator_type,
  _swigc__p_char,
  _swigc__p_chrom_info,
  _swigc__p_const_reference,
  _swigc__p_difference_type,
  _swigc__p_genome_hash_table,
  _swigc__p_genome_table,
  _swigc__p_p_PyObject,
  _swigc__p_reference,
  _swigc__p_size_type,
  _swigc__p_std__allocatorT_StringView_t,
  _swigc__p_std__allocatorT_char_const_p_t,
  _swigc__p_std__allocatorT_chrom_info_t,
  ...
  _swigc__p_std__vectorT_StringView_std__allocatorT_StringView_t_t,
  ...
  _swigc__p_std__vectorT_chrom_info_std__allocatorT_chrom_info_t_t,
  ...
  _swigc__p_vectorT_StringView_std__allocatorT_StringView_t_t,
  _swigc__p_vectorT_std__string_std__allocatorT_std__string_t_t,
  _swigc__p_vectorT_std__vectorT_float_std__allocatorT_float_t_t_std__allocatorT_std__vectorT_float_std__allocatorT_float_t_t_t_t,
};
